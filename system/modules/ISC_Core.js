...
this.moved(_1,_2)}
,isc.A.moved=function(deltaX,deltaY){this.$808=this.$809=null}
...
,isc.A.$u6=function isc_Canvas__scrolled(){if(!isc.EH.$ky){var _1=isc.EH.lastEvent,_2=isc.EH.isMouseEvent(_1.eventType)
currentlyOver=_2?_1.target:isc.EH.lastMoveTarget;if(currentlyOver!=null){if(!this.contains(currentlyOver,true))currentlyOver=null;else if(!_2&&currentlyOver!=this){var _3=this.getOffsetX(),_4=this.getOffsetY();if(!currentlyOver.visibleAtPoint(isc.EH.getX(),isc.EH.getY(),false,null,this))
{currentlyOver=null}}
if(currentlyOver!=null){isc.EH.$kx(null,isc.EH.lastEvent)}}}
...
);isc.evalBoundary;isc.B.push(isc.A.getTextDirection=function isc_Canvas_getTextDirection(){if(this.$81a)return this.$81a;var _1=this;while(_1){if(_1.textDirection!=null){return(this.$81a=_1.textDirection)}
