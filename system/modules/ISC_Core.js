...
,isc.A.getNextGlobalID=function(_1){var _2=_1!=null&&isc.isA.String(_1.Class)?_1.Class:null;return this.getNextGlobalIDForClass(_2)}
,isc.A.getNextGlobalIDForClass=function(_1){if(_1){var _2=this.$63v[_1]
...
);isc.B._maxIndex=isc.C+67;Number.prototype.Class="Number";isc.A=Number.prototype;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.stringify=function(_1,_2){if(!_1)_1=2;var _3=this.toString(),_4=_1-_3.length;if(_2){var _5=_3.indexOf(isc.dot);if(_5!=-1){_4+=(_3.length-_5)}}
...
_4+='\n        "'+_11+'"';return _4},$e6:function(_1){var _2=isc.Func.getBody(_1);return _2.trim()},getStackTrace:function(_1,_2,_3){var _4="";if(isc.Browser.isMoz){}
_4+=this.$76x(_1,_2,_3);if(this.hasFireBug()){isc.Log.$50m=isc.Log.$50m||0;var _5="FBugTrace"+isc.Log.$50m++;_4+="\r\n"+this.fireBugTrace(_5)}
return _4},$76x:function(_1,_2,_3){if(!arguments||!arguments.callee||!arguments.callee.caller){return" [Stack trace not supported in this browser]"}
if(_1==null)_1=arguments.caller||arguments.callee.caller.arguments;var _4=[];for(var i=0;i<_2;i++){if(_1.caller!=null)_1=_1.caller}
var _6=isc.Browser.isIE&&isc.Browser.version<=6;var _7=_1.callee;var _8=[];var _9=true;if(_3==null)_3=Number.MAX_VALUE;var _10=0;while(_7!=null&&_1!=null&&_10<_3){if(!_6){if(_8.contains(_7)){_4.add("    ** recursed on "+isc.Func.getName(_7,true));break}
_8.add(_7)}
_4.add("    "+this.getCallTrace(_1,null,(_9||_1.callee.caller==null)));if(_10==0){var _11=this.$e7(_1.$e8);if(_11)_4.add(_11)}
_7=_1.callee;if(!_6){_7=_7.caller;if(_7)_1=_7.arguments}else _1=_1.caller;_9=false;_10++}
...
,isc.A.$ga=function(_1){if(this._logWindow==null)return;if(isc.Browser.isIE){try{this._logWindow.$gb=true}catch(e){this.delayCall("$ga",[_1],this.$f7);return}}
...
isc.Log.logInfo("initialized");isc.Log.$fy();isc.Log.supportsOnError=(isc.Browser.isIE||(isc.Browser.isMoz&&isc.Browser.geckoVersion>=20080529));if(isc.Log.supportsOnError&&!(window.isc_installOnError==false)){window.onerror=function(_1,_2,_3){var _4=arguments.caller;if(_4==null&&arguments.callee.caller!=null){_4=arguments.callee.caller.arguments}
if(_4&&_4.$e9){return}
...
,isc.A.compareAscending=function(_1,_2){if(_1!=null&&_1.localeCompare!=null){var _3=_1.localeCompare(_2);return _3}
if(_2!=null&&_2.localeCompare!=null){var _3=_2.localeCompare(_1);return _3}
return(_2>_1?-1:_2<_1?1:0)}
,isc.A.compareDescending=function(_1,_2){if(_1!=null&&_1.localeCompare!=null){var _3=_1.localeCompare(_2);return-1*_3}
if(_2!=null&&_2.localeCompare!=null){var _3=_2.localeCompare(_1);return-1*_3}
return(_2<_1?-1:_2>_1?1:0)}
,isc.A.safariCompareAscending=function(_1,_2){if(_1!=null&&_1.localeCompare!=null){var _3=_1.localeCompare(_2);return _3-2}
if(_2!=null&&_2.localeCompare!=null){var _3=_2.localeCompare(_1);return _3-2}
return(_2>_1?-1:_2<_1?1:0)}
,isc.A.safariCompareDescending=function(_1,_2){if(_1!=null&&_1.localeCompare!=null){var _3=_1.localeCompare(_2);return-1*(_3-2)}
...
,isc.A.getUTCHoursDisplayOffset=function(_1){var _2=this.currentlyInDST?-(this.dstDeltaHours):0;if(this.adjustForDST){if(_1.getTimezoneOffset()==this.januaryDstOffset){if(this.southernHemisphere){_2+=this.dstDeltaHours}}else{if(!this.southernHemisphere){_2+=this.dstDeltaHours}}}
return this.UTCHoursDisplayOffset+(this.adjustForDST?_2:0)}
,isc.A.getUTCMinutesDisplayOffset=function(_1){var _2=this.currentlyInDST?-(this.dstDeltaMinutes):0;if(this.adjustForDST){if(_1.getTimezoneOffset()==this.januaryDstOffset){if(this.southernHemisphere){_2+=this.dstDeltaMinutes}}else{if(!this.southernHemisphere){_2+=this.dstDeltaMinutes}}}
...
,isc.A.getEventTargetCanvas=function(_1,_2){if(_1==null)_1={};var _3=this,_4=this.getWindow();if(!_2)_2=(isc.Browser.isIE?_1.srcElement:_1.target);if(!_3.$l7(_2)){return _3.lastTarget}
...
,isc.A.rightButtonDown=function(_1){if(!_1)_1=this.lastEvent;return(_1.buttonNum==2)||(_1.button==2)||(isc.Browser.isMac&&_1.ctrlKey)||(isc.Browser.isOpera&&(_1.ctrlKey&&_1.shiftKey))||((isc.Browser.isSafari&&(isc.Browser.safariVersion<125))&&_1.altKey)}
...
,isc.A.$mk=function(_1){if(!_1)_1=document;if(isc.Browser.isIE){var _2=_1.selection,_3=_2.type.toLowerCase(),_4=(_3=="text"||_3=="none");if(!_2)return null;if(_4){var _5;try{_5=_2.createRange()}catch(e){}
...
,isc.A.$px=function(_1){if(isc.$cv)arguments.$cw=this;var _2=this.getInnerHTML(_1);if(this.$pz){var _3=this.$pz.join(isc.emptyString);_2=(_2==null||_2==isc.nbsp?_3:_2+_3)}
return _2}
...
);isc.evalBoundary;isc.B.push(isc.A.getTagStart=function(_1){var _2=isc.Canvas,_3=this.$rw();if(this.zIndex==_2.AUTO)this.zIndex=_2.getNextZIndex();var _4=(this.eventProxy?this.eventProxy.ID:this.ID);var _5=this.$rx(),_6=_5[0],_7=_5[1];if(!_2.$ry){_2.$ry=" onfocus=";_2.$rz=" onblur=";_2.$r0=" tabindex="
_2.$r1=" accessKey="}
...
,isc.A.$v8=function(_1){if(this.isDrawn()){if((isc.Browser.isMoz||(isc.Browser.isStrict&&isc.Browser.isSafari))&&_1=="hand")_1=isc.Canvas.HAND;this.$v9=_1;this.getStyleHandle().cursor=_1;if(this.useClipDiv)this.getHandle().style.cursor=_1;if(this.$kt){for(var i=0;i<this.$kt.length;i++){this.$kt[i].$v8(_1)}}
...
,isc.A.$xo=function(_1){if(this.usePNGFix==false)return false;var _2=isc.Browser.isIE&&isc.Browser.minorVersion>=5.5&&isc.Browser.isWin&&this.neverUsePNGWorkaround!=true;if(_2&&_1&&_1.$xo&&!_1.$xo()){_2=false}
return _2}
...
,isc.A.updateDataModel=function(_1,_2,_3){this.logDebug("Setting filter to: "+this.echoFull(_1));var _4=this.getData();_4.setContext(_3);if(!_4.willFetchData(_1))delete _3.afterFlowCallback;_4.setCriteria(_1)}
...
,isc.A.getSelection=function(_1){if(!this.selection)return null;if(this.canSelectCells){var _2=this.selection.getSelectedCells();if(_2==null)return null;var _3=[];for(var i=0;i<_2.length;i++){var _5=_2[i],_6=this.getCellRecord(_5[0],_5[1]);if(_6==null)continue;_3.add(_6)}
...
,isc.A.isSelected=function(_1){if(!_1||!this.selection)return false;return this.selection.isSelected(_1)}
,isc.A.isPartiallySelected=function(_1){if(!_1||!this.selection)return false;return this.selection.isPartiallySelected(_1)}
...
if(_6){this.$67o=isc.rpc.startQueue();for(var i=0;i<_1.length;i++){if(_1[i].$52e)continue;var _10={};isc.addProperties(_10,_1[i]);isc.addProperties(_10,this.getDropValues(_10,_7,_2,_3,_4));if(_6!=_7){if(this.dragRecategorize||_4.dragDataAction==isc.Canvas.MOVE){var _13=_6.getForeignKeysByRelation(_10,_7);var _14=false;var _15=[];if(_7)_15=_7.getPrimaryKeyFields();var _16;for(var _17 in _15){if(_13[_17]!==_16){if(this.dragRecategorize){this.logWarn("ListGrid dragRecategorize: source has dataSource:"+_7.getID()+". foreignKey relationship with "+"target dataSource "+_6.getID()+" is based on primary key which cannot be modified.")}
_14=true}}
...
,isc.A.updateDataViaDataSource=function(_1,_2,_3,_4){var _5=this;if(this.updateOperation){if(_3==null)_3={};isc.addProperties(_3,{operationId:this.updateOperation})}
...
,isc.A.$61d=function(_1,_2,_3,_4,_5,_6){var _7=this.getDataSource(),_8,_9=this,_10={};if(this.addOperation){isc.addProperties(_10,{operationId:this.addOperation})}
...
return _3}
);isc.evalBoundary;isc.B.push(isc.A.getDragData=function(){var _1=(this.selection&&this.selection.getSelection)?this.selection.getSelection():null;return _1}
,isc.A.cloneDragData=function(){var _1=this.$758;if(_1==null){_1=(this.selection&&this.selection.getSelection)?this.selection.getSelection():null}
...
,isc.A.getClientExportData=function(_1){var _2=this.originalData||this.data,_3=[],_4=this.getClientExportFields(_1),_5,_6,_7;if(isc.isA.Object(_1)){_5=_1.includeHiddenFields;_6=_1.allowedProperties;_7=_1.includeCollapsedNodes;if(_1&&_1.exportFields){if(_5!==false)_5=true}}
...
return _3}
,isc.A.getClientExportFields=function(_1){var _2=this.getAllFields();if(isc.isA.Object(_1)){if(_1&&_1.exportFields){var _3=[];for(var i=0;i<_2.length;i++){if(_1.exportFields.contains(_2[i].name))_3.add(_2[i])}
_2=_3}}
return _2}
,isc.A.getRecordExportObject=function(_1,_2,_3,_4,_5){var _6={}
...
,isc.A.getFormattingProperties=function(_1,_2){if(_1.type!="date"&&_1.type!="datetime")return;var _3;if(_1.displayFormat&&isc.isA.Function(Date.prototype[_1.displayFormat])){_3=_1.displayFormat}
...
,isc.A.$742=function(_1,_2,_3){if(_1.status==isc.DSResponse.STATUS_FAILURE){isc.logWarn("Server-side validation failed: "+_1.data);isc.say(_1.data)}
...
,isc.A.getElement=function(_1){if(!_1)return null;if(_1.startsWith("'")||_1.startsWith('"'))_1=_1.substring(1);if(_1.endsWith("'")||_1.endsWith('"'))_1=_1.substring(0,_1.length-1);if(!_1.startsWith("//")){if(_1.startsWith("ID=")||_1.startsWith("id=")){_1=_1.substring(3)}
_1='//*any*[ID="'+_1+'"]'}
...
return null}
,isc.A.createLocatorFallbackPath=function(_1,_2){var _3=[];for(var _4 in _2){var _5=_2[_4];if(isc.isA.String(_5)){_5=_5.replace("/",this.slashMarker);_5=escape(_5)}
