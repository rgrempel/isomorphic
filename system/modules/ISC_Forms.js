...
,isc.A.valuesHaveChanged=function isc_DynamicForm_valuesHaveChanged(){var _1=this.getValues(),_2=this.$10s,_3=false;if(!isc.isAn.Object(_2))_2={};for(var _4 in _1){if(isc.isA.Function(_1[_4]))continue;var _5=this.getItem(_4);if(_5!=null){_3=!_5.compareValues(_1[_4],_2[_4])}else{_3=!isc.DynamicForm.compareValues(_1[_4],_2[_4])}
if(_3)return true}
return _3}
,isc.A.getValues=function isc_DynamicForm_getValues(){this.updateFocusItemValue();return this.values}
,isc.A.updateFocusItemValue=function isc_DynamicForm_updateFocusItemValue(){var _1=this.getFocusItem();if(!this.$10u&&_1!=null&&_1.$10v()){_1.updateValue()}}
,isc.A.getData=function isc_DynamicForm_getData(){return this.getValues()}
,isc.A.getValuesAsCriteria=function isc_DynamicForm_getValuesAsCriteria(_1,_2){if(_1==null){_1=(this.operator!="and")||this.getItems().map("hasAdvancedCriteria").contains(true)||(this.$76u!=null)}
...
if(!_1){return isc.addProperties(_2,_3)}else{for(var _11 in _2){if(_4.find("fieldName",_11))continue;if(_2[_11]==null)continue;_4.add({operator:"equals",fieldName:_11,value:_2[_11]})}
return _4}}
...
,isc.A.getValuesAsAdvancedCriteria=function isc_DynamicForm_getValuesAsAdvancedCriteria(_1){return this.getValuesAsCriteria(true,_1)}
...
,isc.A.getValue=function isc_DynamicForm_getValue(_1){var _2=this.getItem(_1);if(_2)return _2.getValue();return this.$70p(_1)}
...
,isc.A.getFieldErrors=function isc_DynamicForm_getFieldErrors(_1){if(!this.errors)return null;if(isc.isA.FormItem(_1))_1=_1.getFieldName();return this.errors[_1]}
...
,isc.A.redraw=function isc_DynamicForm_redraw(){this.$107();this.$106();this.Super("redraw",arguments);this.$108();this.setItemValues(null,true);var _1,_2,_3;if(isc.Browser.isMoz){_3=this.getClipHandle();if(_3){_1=_3.scrollLeft;_2=_3.scrollTop}}
...
,isc.A.redrawFormItem=function isc_DynamicForm_redrawFormItem(_1,_2){var _3=this.getItems();if(!_1||!_3.contains(_1))return;this.$10m=true;this.markForRedraw(_1.ID+": "+(_2?_2:"redrawFormItem"))}
...
return _1}
,isc.A.setItemValues=function isc_DynamicForm_setItemValues(_1,_2,_3,_4){var _5=(_1==null);if(_5)_1=this.getValues();if(_1==null)_1={};_4=_4||this.items;for(var _6=0;_6<_4.length;_6++){var _7=_4[_6],_8=_7.getFieldName(),_9=_7.getDataPath(),_10=_7.isSetToDefaultValue(),_11;if(_9){var _12=_9.split(isc.slash),_13=_1;for(var i=0;i<_12.length-1;i++){_13=_13[_12[i]];if(_13==null)break}
...
);isc.evalBoundary;isc.B.push(isc.A.getCellEndHTML=function isc_DynamicForm_getCellEndHTML(_1,_2){return this.$11h()}
...
,isc.A.getFocusItem=function isc_DynamicForm_getFocusItem(){return this.$10n}
,isc.A.$vl=function isc_DynamicForm__readyToSetFocus(){return!this.isDisabled()}
,isc.A.setFocus=function isc_DynamicForm_setFocus(_1){if(!this.$vl())return;var _2=this.isVisible();if(_1){var _3=this.getFocusItem();if(_3==null){var _4=this.getItems();for(var i=0;i<_4.length;i++){var _6=_4[i];if(_6.$kk()&&_6.isDrawn()&&_6.isVisible()&&!_6.isDisabled())
{_3=_6;break}}}
...
,isc.A.focusInItem=function isc_DynamicForm_focusInItem(_1){if(_1!=null){var _2=this.getItem(_1)}else{var _2=this.getFocusItem()}
...
,isc.A.blurFocusItem=function isc_DynamicForm_blurFocusItem(){var _1=this.getFocusItem();if(_1!=null){this.$11r(_1);this.clearFocusItem()}}
,isc.A.$11r=function isc_DynamicForm__blurItem(_1){if(_1!=null)_1.blurItem()}
,isc.A.$106=function isc_DynamicForm__blurFocusItemWithoutHandler(){var _1=this.getFocusItem();if(_1!=null&&_1.hasFocus){if(this.$11v==null)this.$11v=0;else this.$11v+=1;this.$11r(_1)}else{this.logDebug("blur w/o handler: no item to blur")}}
...
,isc.A.hide=function isc_DynamicForm_hide(){if(isc.Browser.isMoz)this.$11r(this.getFocusItem());this.Super("hide",arguments)}
...
this.$11a()}
,isc.A.$lf=function isc_DynamicForm__focusChanged(_1){this.Super("$lf",arguments);if(!this.hasFocus)this.$11r(this.getFocusItem())}
,isc.A.parentVisibilityChanged=function isc_DynamicForm_parentVisibilityChanged(_1){if(!this.isVisible()&&isc.Browser.isMoz)this.$11r(this.getFocusItem());this.Super("parentVisibilityChanged",arguments);this.itemsVisibilityChanged();if(this.isVisible()&&this.autoFocus)this.focus()}
...
,isc.A.handleKeyPress=function isc_DynamicForm_handleKeyPress(_1,_2){if(_1.keyName==this.$10j){if(this.saveOnEnter){var _3=this.getFocusItem();if(isc.isA.TextItem(_3))this.submit()}}
...
if(this.$118[_1.keyName]&&_1.keyTarget!=this){var _3=this.getItem(_1.keyTarget.name);if(!_3)return isc.EventHandler.STOP_BUBBLING}
...
,isc.A.setupInactiveContext=function isc_FormItem_setupInactiveContext(_1){if(_1==null)_1={};if(this.containerWidget&&this.containerWidget.isPrinting)_1.isPrintHTML=true;var _2=this.$68w++;_1.inactiveContextID=_2;_1.formItem=this;if(!this.$68v)this.$68v={};this.$68v[_2]=_1;return _2}
...
,isc.A.getOuterTableCSS=function isc_FormItem_getOuterTableCSS(){var _1=this.$139;var _2,_3=this.expandHintAndErrors;if(_3&&this.getHint()==null){var _4=this.getErrorOrientation();_3=(_4==isc.Canvas.LEFT||_4==isc.Canvas.RIGHT)}
...
,isc.A.getTextBoxCSS=function isc_FormItem_getTextBoxCSS(){var _1=isc.SB.create();var _2=this.getTextBoxWidth();if(isc.isA.Number(_2)){if((isc.Browser.isOpera||isc.Browser.isMoz||isc.Browser.isSafari)&&!this.clipValue){_1.append(this.$137,_2,this.$38)}else{_1.append(this.$93,_2,this.$38)}}
...
,isc.A.$109=function isc_FormItem__refocusAfterRedraw(){var _1=this.isDrawn()&&this.isVisible();if(_1){var _2=isc.EH.getFocusCanvas();if(_2!=null&&_2!=this.form){_1=false}else{var _3=this.form.getFocusItem();if(_3!=this&&_3!=this.parentItem&&(!this.items||!this.items.contains(_3)))
{_1=false}}}
...
,isc.A.$16r=function isc_FormItem__applyIconHSpaceToLink(_1){return(!isc.Browser.isIE&&!_1.imgOnly&&!isc.Browser.isStrict)}
...
,isc.A.$17c=function isc_FormItem__formatDataType(_1){if(this.applyStaticTypeFormat){if(this.formatValue!=null){var _2=this.form,_3=this.form?this.form.values:{};return this.formatValue(_1,_3,_2,this)}}else if(this.formatEditorValue!=null){var _2=this.form,_3=this.form?this.form.values:{};return this.formatEditorValue(_1,_3,_2,this)}
...
return _1}
,isc.A.mapDisplayToValue=function isc_FormItem_mapDisplayToValue(_1){if(!this.applyStaticTypeFormat&&this.parseEditorValue!=null){return this.parseEditorValue(_1,this.form,this)}
return this.$17d(_1)}
,isc.A.$17b=function isc_FormItem__mapKey(_1,_2){var _3=_2?null:_1;var _4=this.getValueMap();if(!_4)return _3;if(isc.isA.String(_4))_4=this.getGlobalReference(_4);if(isc.isAn.Array(_4))return _3;var _5;if(isc.isAn.Array(_1)){_5="";for(var i=0;i<_1.length;i++){_5+=isc.getValueForKey(_1[i],_4,_3);if(i!=_1.length-1)_5+=this.multipleValueSeparator}}else{_5=isc.getValueForKey(_1,_4,_3)}
return _5}
...
,isc.A.setValue=function isc_FormItem_setValue(_1,_2){this.$17g=true;this.$751=null;var _3=(this.maintainSelectionOnTransform&&this.hasFocus&&(this.$17h()!=this.$14l));if(_3)this.rememberSelection();if(this.$17i!=null){isc.Timer.clearTimeout(this.$17i);this.$17i=null}
...
this.clearValue()}
,isc.A.$43f=function isc_FormItem__checkForDisplayFieldValue(_1){var _2=(this.$17b(_1,true)!=null);if(!_2){var _3=this.getOptionDataSource();if(_3&&(this.$63l==null||!this.$63l[_1]))
...
,isc.A.getSelectedRecord=function isc_FormItem_getSelectedRecord(){if(!this.$751&&this._value!=null&&this.optionDataSource){if(this.pickList&&this.pickList.data)
...
);isc.evalBoundary;isc.B.push(isc.A.setToDefaultValue=function isc_FormItem_setToDefaultValue(){return this.clearValue()}
...
,isc.A.handleChanged=function isc_FormItem_handleChanged(_1){if(this.changed)this.changed(this.form,this,_1);if(this.form&&this.form.itemChanged!=null){this.form.itemChanged(this,_1)}}
...
,isc.A.getCriteriaFieldName=function isc_FormItem_getCriteriaFieldName(){return this.getFieldName()}
...
,isc.A.getOperator=function isc_FormItem_getOperator(){if(this.operator){var _1=this.operator}else{if(this.valueMap||this.optionDataSource||isc.SimpleType.inheritsFrom(this.type,"enum")||isc.SimpleType.inheritsFrom(this.type,"boolean"))
{_1="equals"}else{_1="iContains"}}
return _1}
,isc.A.canEditCriterion=function isc_FormItem_canEditCriterion(_1){if(_1.fieldName!=null&&_1.fieldName==this.getCriteriaFieldName()){if(_1.operator!=this.getOperator()){this.logWarn("Attempting to edit AdvancedCriteria in a dynamicForm. Criteria "+"includes a value for field:"+_1.fieldName+". Matches the fieldName for this item, but the specified operator:"+_1.operator+" does not match the operator for this form item:"+this.getOperator()+". Unclear how to combine values for this field, so "+"leaving original criterion in place.");return false}
return true}
return false}
,isc.A.getCriterion=function isc_FormItem_getCriterion(){var _1=this.getCriteriaValue();if(_1==null||isc.is.emptyString(_1))return;if(isc.isAn.Array(_1)){if(_1.length==0||_1.contains(isc.emptyString))return}
...
,isc.A.hasErrors=function isc_FormItem_hasErrors(){if(this.parentItem!=null)return this.parentItem.hasErrors();var _1=this.getFieldName();if(_1&&this.form)return this.form.hasFieldErrors(_1);return false}
...
_2+=" - returning zero.";this.form.logWarn(_2);return 0}
return this.$18k(_1)}
,isc.A.$18k=function isc_FormItem__getElementLeft(_1){var _2=_1.offsetParent,_3=this.containerWidget.getHandle(),_4=_3.offsetParent,_5=isc.Element.getOffsetLeft(_1);while(_2!=_3&&_2!=_4){_5+=isc.Element.getOffsetLeft(_2)
...
return _5}
);isc.evalBoundary;isc.B.push(isc.A.$145=function isc_FormItem__isValidIcon(_1){return(_1!=null&&(this.icons&&this.icons.contains(_1)||this.showPickerIcon&&this.getPickerIcon()==_1))}
...
_2+=" - returning zero.";this.form.logWarn(_2);return 0}
return this.$18l(_1)}
,isc.A.$18l=function isc_FormItem__getElementTop(_1){var _2=this.containerWidget.getHandle(),_3=_2.offsetParent,_4=_1.offsetParent,_5=isc.Element.getOffsetTop(_1);while(_4!=_2&&_4!=_3){_5+=isc.Element.getOffsetTop(_4)
...
,isc.A.$18y=function isc_CanvasItem__createCanvas(){if(!isc.isAn.Object(this.canvas)&&!this.canvasProperties&&!window[this.canvas]){if(isc.designTime)return;this.logWarn("CanvasItem: "+(this.getFieldName()?this.getFieldName():this.getID())+" defined with no canvas property - creating a default "+"canvas for this item.")}
...
return _3}
,isc.A.getElementStyleHTML=function isc_TextItem_getElementStyleHTML(){var _1=this.$19a,_2=this.getTextBoxWidth(),_3=this.getTextBoxHeight(),_4=this.getTextBoxStyle();_1[1]=_4;if(isc.isA.Number(_2)){_1[3]=this.$93;isc.$bk(_1,_2,4,4);_1[8]=this.$38}else{_1[3]=_1[4]=_1[5]=_1[6]=_1[7]=_1[8]=null}
...
return _1}
,isc.A.getCriteriaFieldName=function isc_TextItem_getCriteriaFieldName(){if(this.displayField)return this.displayField;return this.getFieldName()}
...
this.$72a(_1)}
,isc.A.$72f=function isc_TextItem__shiftMaskBufferLeft(_1,_2){if(!_2)_2=1;while(!this.$72i[_1]&&_1>=0)_1--;for(var i=_1,_4=i+_2-1;i<this.$718;i++){if(this.$72i[i]){this.$72l[i]=this.maskPromptChar;var j=this.$72h(_4++);var _6=this.$72i[i];var c=this.$72l[j];if(j<this.$718&&_6.filter.test(c)){if(_6.casing){c=this.$72j(c,_6.casing)}
...
this.$19r(this.pickListWidth!=null?this.pickListWidth:this.getElementWidth(),_5,(_5==this.pickListHeight));_1.placeNear(_3,_4)},getSelectedRecord:function(){if(this.pickList==null||this.pickList.destroyed)this.makePickList(false);if(this.selectItemFromValue(this.getValue()))return this.pickList.getSelectedRecord();return null},pickValue:function(_1){}});isc.A=isc.PickList;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.optionsFromValueMap=function isc_c_PickList_optionsFromValueMap(_1){var _2=_1.getValueMap(),_3=[];if(_2==null)_2=[];var _4=_1.getValueFieldName();if(isc.isAn.Array(_2)){for(var i=0;i<_2.length;i++){_3[i]={}
...
_1=_3}
return _1}
,isc.A.$194=function isc_SelectItem__valueIsValid(_1){if(this.addUnknownValues||this.optionDataSource)return true;if(_1==null)return true;return this.$193(_1)}
...
return _2}}
);isc.B._maxIndex=isc.C+3;isc.A=isc.NativeSelectItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_NativeSelectItem_init(){this.Super("init",arguments);isc.NativeSelectItem.instances.add(this);if(this.optionDataSource){var _1=this.getOptionDataSource();var _2=this.getValueFieldName();var _3=this.getDisplayFieldName();var _4=this;_1.fetchData(null,function(_8,_9){var _5;if(!_3)_5=[];else _5={};for(var i=0;i<_9.getLength();i++){var _7=_9[i];if(!_3){_5.add(_7[_2])}else{_5[_7[_2]]=_7[_3]}}
_4.setValueMap(_5)})}}
...
return _4}
,isc.A.parseDate=function isc_DateItem_parseDate(_1,_2){if(_2==null)_2=this.getInputFormat();return Date.parseInput(_1,_2,this.centuryThreshold,true,this.useCustomTimezone)}
...
,isc.A.showPicker=function isc_DateItem_showPicker(){if(!this.picker){if(this.useSharedPicker)this.picker=isc.DateChooser.getSharedDateChooser();else{this.picker=isc[this.pickerConstructor].create(isc.addProperties({},this.pickerDefaults,this.pickerProperties,{border:"none",_generated:true,autoHide:true,showCancelButton:true}))}}
...
return _1}
,isc.A.getCriteriaFieldName=function isc_ComboBoxItem_getCriteriaFieldName(){if(this.displayField&&!this.getSelectedRecord())return this.displayField;return this.getFieldName()}
...
return _1}
,isc.A.showPicker=function isc_ColorItem_showPicker(){if(!this.picker){this.picker=isc.ColorChooser.getSharedColorPicker(this.pickerDefaults)}
...
);isc.B._maxIndex=isc.C+63;isc.ValuesManager.registerStringMethods({handleHiddenValidationErrors:"errors"});isc.ClassFactory.defineClass("ColorPicker",isc.Window);isc.A=isc.ColorPicker;isc.A.MORE_BUTTON_TITLE="More >>";isc.A.LESS_BUTTON_TITLE="<< Less";isc.A=isc.ColorPicker;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSharedColorPicker=function isc_c_ColorPicker_getSharedColorPicker(_1,_2){if(!isc.isA.ColorPicker(this.$56b)){this.$56b=isc.ColorPicker.create(_1)}
...
,isc.A.dateAdd=function isc_c_RelativeDateItem_dateAdd(_1,_2,_3,_4){var _5=isc.RelativeDateItem,_6=_1;switch(_2){case"MS":case"ms":_6.setUTCMilliseconds(_1.getUTCMilliseconds()+(_3*_4));break;case"S":case"s":_6.setUTCSeconds(_1.getUTCSeconds()+(_3*_4));if(_2=="S"){_6=_5.getEndOf(_6,"S");break}
...
this.setValue(this.defaultValue)}
,isc.A.valueFieldChanged=function isc_RelativeDateItem_valueFieldChanged(_1){this.fieldChanged();if(this.quantityField.isVisible())this.quantityField.delayCall("focusInItem")}
,isc.A.quantityFieldChanged=function isc_RelativeDateItem_quantityFieldChanged(_1){this.fieldChanged()}
,isc.A.fieldChanged=function isc_RelativeDateItem_fieldChanged(){if(!this.valueField||!this.quantityField)return;var _1=this.valueField.getValue(),_2=this.quantityField.getValue();var _3=(_1&&isc.isA.String(_1)&&_1.indexOf("_")!=-1);if(!_3){this.quantityField.hide()}else{this.quantityField.show()}
if(this.calculatedDateField){var _1=this.getValue();this.calculatedDateField.setValue(!_1?"":"("+this.formatDate(_1)+")")}}
,isc.A.getValueFieldOptions=function isc_RelativeDateItem_getValueFieldOptions(){var _1=isc.clone(this.presetOptions);for(var i=0;i<this.timeUnitOptions.length;i++){var _3=this.timeUnitOptions[i];_1[_3+"_ago"]=this[_3+"sAgoTitle"];_1[_3+"_fromNow"]=this[_3+"sFromNowTitle"]}
return _1}
,isc.A.setValue=function isc_RelativeDateItem_setValue(_1){if(_1==null){this.valueField.setValue(null);this.valueFieldChanged(_1);return}
...
,isc.A.updateValue=function isc_RelativeDateItem_updateValue(_1){this.$10y(_1)}
...
,isc.A.getCriterion=function isc_DateRangeItem_getCriterion(_1){_1=_1||!this.allowRelativeDates;var _2=_1?this.fromField.getValue():this.fromField.getRelativeDate()||this.fromField.getValue(),_3=_2!=null,_4=_1?this.toField.getValue():this.toField.getRelativeDate()||this.toField.getValue(),_5=_4!=null,_6=null;if(_3||_5){_6={_constructor:"AdvancedCriteria",operator:"and",criteria:[]};if(_3){_6.criteria.add({fieldName:this.name,operator:"greaterThan",value:_2})}
if(_5){_6.criteria.add({fieldName:this.name,operator:"lessThan",value:_4})}}
return _6}
...
return true}
return false}
,isc.A.setCriterion=function isc_DateRangeItem_setCriterion(_1){var _2,_3;if(_1.operator=="and"){_2=_1.criteria.find("operator","greaterThan");_3=_1.criteria.find("operator","lessThan")}else{if(_1.operator=="greaterThan")_2=_1;else if(_1.operator=="lessThan")_3=_1}
...
,isc.A.accept=function isc_DateRangeDialog_accept(){this.finished(this.rangeItem.getValue())}
...
,isc.A.rangeDialogCallback=function isc_MiniDateRangeItem_rangeDialogCallback(_1){this.setValue(_1)}
...
,isc.A.setCriterion=function isc_MiniDateRangeItem_setCriterion(_1){if(this.rangeItem)this.rangeItem.setCriterion(_1)}
...
,isc.A.setValue=function isc_MiniDateRangeItem_setValue(_1){if(_1!=null){if(isc.DataSource.isAdvancedCriteria(_1)){var _2={};for(var i=0;i<_1.criteria.length;i++){var _4=_1.criteria[i];if(_4.operator=="greaterThan")
_2.start=_4.value;else if(_4.operator=="lessThan")
_2.end=_4.value}
_1=_2}
this.fromDate=_1.start;this.toDate=_1.end}else{this.fromDate=null;this.toDate=null}
this.rangeItem.setFromDate(this.fromDate);this.rangeItem.setToDate(this.toDate);var _5=this.mapValueToDisplay(_1);this.setElementValue(_5,_1);this.Super("setValue",[_1])}
,isc.A.mapValueToDisplay=function isc_MiniDateRangeItem_mapValueToDisplay(_1){if(_1==null)return;var _2=isc.RelativeDateItem,_3=(_2.isRelativeDate(this.fromDate)?_2.getAbsoluteDate(this.fromDate.value):this.fromDate),_4=(_2.isRelativeDate(this.toDate)?_2.getAbsoluteDate(this.toDate.value):this.toDate);var _5;if(_3||_4){if(this.dateDisplayFormat){if(_3)_5=this.formatDate(_3);if(_4){if(_5)_5+=" - "+this.formatDate(_4);else _5=this.formatDate(_4)}}else _5=Date.getFormattedDateRangeString(_3,_4);if(!_3)_5=this.toDateOnlyPrefix+" "+_5;else if(!_4)_5=this.fromDateOnlyPrefix+" "+_5}
...
,isc.A.updateValue=function isc_MiniDateRangeItem_updateValue(_1){this.$10y(_1)}
