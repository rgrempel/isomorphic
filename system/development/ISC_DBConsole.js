...
,isc.A.getDefinedDataSources=function(){isc.DMI.call({appID:"isc_builtin",className:"com.isomorphic.tools.BuiltinRPC",methodName:"getDefinedDataSources",callback:this.getID()+".dsList.setData(data);",requestParams:{prompt:"Please wait - loading list of available DataSources.",showPrompt:true}})}
...
,isc.A.importDataSources=function(){var _1=this.dsOptions.getValues();_1.dsList=this.dsList.getSelection().getProperty("dsName").getUniqueItems();isc.DMI.call({appID:"isc_builtin",className:"com.isomorphic.tools.AdminConsole",methodName:"importDataSources",callback:"isc.say(data)",arguments:[_1.dsList,_1.importTestData,_1.replaceTables],requestParams:{prompt:"Importing Datasource[s] - This may take a few minutes.",showPrompt:true}})}
...
,isc.A.getDefinedDatabases=function(){isc.DMI.call({appID:"isc_builtin",className:"com.isomorphic.tools.AdminConsole",methodName:"getDefinedDatabases",callback:this.getID()+".getDefinedDatabasesCallback(data)",requestParams:{prompt:"Please wait - getting list and status of configured database.",showPrompt:true}})}
...
,isc.A.setDefaultDB=function(_1){isc.DMI.call({appID:"isc_builtin",className:"com.isomorphic.tools.AdminConsole",methodName:"setDefaultDB",arguments:[_1],callback:this.getID()+".setDefaultDBCallback(data)"})}
...
,isc.A.testDB=function(){if(!this.dbForm.validate())return;var _1=this.dbForm.getValue("dbName");var _2=this.dbForm.getValues();isc.DMI.call({appID:"isc_builtin",className:"com.isomorphic.tools.AdminConsole",methodName:"testDB",arguments:[_1,_2],callback:this.getID()+".testDBCallback(data)",requestParams:{willHandleError:true}})}
,isc.A.testDBCallback=function(_1){isc.say(_1,{title:"Result of test"})}
,isc.A.saveDB=function(){if(!this.dbForm.validate())return;isc.RPCManager.startQueue();isc.DMI.call({appID:"isc_builtin",className:"com.isomorphic.tools.AdminConsole",methodName:"saveDBConfig",arguments:[this.dbForm.getValues()],callback:this.getID()+".saveDBCallback(data)"});this.getDefinedDatabases();isc.RPCManager.sendQueue()}
