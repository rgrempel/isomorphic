...
,isc.A.$36t=function(_1,_2,_3,_4,_5,_6){if(isc.isAn.Instance(_2))_1=_2.getClassName();else if(_2._constructor&&_2._constructor!="AdvancedCriteria"&&_2._constructor!="RelativeDate")_1=_2._constructor;var _7=isc.Comm.$36u(_1,"Object",null,null,null,_6);var _8;_2=isc.JSONEncoder.$42b(_2);for(var _9 in _2){if(_9==null)continue;if(_9==isc.gwtRef)continue;if(_9.startsWith('$'))continue;var _10=_2[_9];if(_10===_8)continue;if(isc.isA.Function(_10)&&!_10.iscAction)continue;var _11=_9.toString();var _12={objRefs:_4,objPath:isc.JSONEncoder.$zp(_3,_9),isRoot:false};_7=isc.StringBuffer.concat(_7,(_5!=null?isc.StringBuffer.concat("\r",_5,"\t"):""),isc.Comm.$ew(_11,_10,(_5!=null?isc.StringBuffer.concat(_5,"\t"):null),_12))}
_7=isc.StringBuffer.concat(_7,(_5!=null?isc.StringBuffer.concat("\r",_5):""),isc.Comm.$36v(_1));return _7}
...
,isc.A.cacheNeedsRefresh=function(){var _1=new Date().getTime(),_2=((_1-this.cacheLastFetchTime)/1000),_3=(this.cacheLastFetchTime==0||_2>this.cacheMaxAge);if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("cacheNeedsRefresh returns "+_3,"cacheAllData")}
return _3}
,isc.A.setCacheData=function(_1,_2){if(this.cacheAllData||this.clientOnly){if(_2){if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("setCacheData: invalidating the cache","cacheAllData")}
...
,isc.A.clearDeferredRequests=function(_1){if(!this.$498)return;_1=_1||"any";if(!isc.isAn.Array(_1))_1=[_1];if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("clearDeferredRequests: "+this.$498.length+" requests, "+"clearing those of type "+isc.echoAll(_1),"cacheAllData")}
...
,isc.A.processDeferredRequests=function(){if(!this.$498)return;if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("processDeferredRequests: processing "+this.$498.length+" deferred requests","cacheAllData")}
var _1=this.$498;this.clearDeferredRequests();for(var i=0;i<_1.length;i++){this.sendDSRequest(_1[i])}}
,isc.A.invalidateCache=function(){if(!this.cacheAllData&&!this.clientOnly)return;if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("invalidateCache: invalidating client-side cache","cacheAllData")}
...
,isc.A.setClientOnly=function(_1){if(_1){this.clientOnly=true
...
,isc.A.hasAllData=function(){if(this.cacheResultSet)return this.cacheResultSet.lengthIsKnown();else return false}
,isc.A.convertRelativeDates=function(_1,_2,_3,_4){if(!_1)return null;if(!this.isAdvancedCriteria(_1)&&_1.operator==null){return _1}
var _5=isc.RelativeDate,_6=isc.addProperties({},_1);_4=_4||new Date();if(_3==null)_3=isc.DateChooser.firstDayOfWeek;if(_6.criteria&&isc.isAn.Array(_6.criteria)){var _7=_6.criteria;for(var i=0;i<_7.length;i++){var _9=_7[i];if(_9.criteria&&isc.isAn.Array(_9.criteria)){_6.criteria[i]=this.convertRelativeDates(_9,_2,_3,_4)}else{_6.criteria[i]=this.mapRelativeDate(_9,_4)}}}else{_6=this.mapRelativeDate(_6,_4)}
return _6}
,isc.A.mapRelativeDate=function(_1,_2){var _3=isc.addProperties({},_1),_4,_5;_2=_2||new Date();if(_3.value&&isc.isAn.Object(_3.value)&&_3.value._constructor=="RelativeDate")
...
,isc.A.$754=function(_1){if(!this.$624)this.$624={};this.$624[_1.requestId]=_1}
...
_1.originalData=_1.data;this.$754(_1);if(!this.sendExtraFields){var _6=_1.data;if(!isc.isAn.Array(_6))_6=[_6];for(var i=0;i<_6.length;i++){var _8=_6[i];if(!isc.isAn.Object(_8))continue;for(var _9 in _8){if(!this.getField(_9))delete _8[_9]}}}
var _10=this.transformRequest(_1);if(_10!==_1){_1.data=_10;if(this.autoConvertRelativeDates==true){_10=this.convertRelativeDates(_10);_1.data=_10}}
var _11=this.getDataProtocol(_1),_12=_11=="clientCustom";if(_12){return{dataProtocol:"clientCustom"}}else{delete this.$624[_1.requestId]}
...
this.$38b(_4,_2,_3)}
,isc.A.$50e=function(_1,_2,_3){var _4=this.cacheAllData&&!this.clientOnly?this.cacheResultSet.getAllRows():null,_5=this.getClientOnlyResponse(_3.$374,_4),_6=_3.$374;this.$38b(_2,_5,_6,_1,_3)}
...
,isc.A.$377=function(_1,_2,_3){var _4=_3.$374,_5=this.getOperationBinding(_4).recordXPath||this.recordXPath;if((_1.$38c||_1.$69j)&&this.logIsDebugEnabled("xmlBinding")){this.logDebug("Raw response data: "+this.echoFull(_2),"xmlBinding")}
...
if(_2.textMatchStyle==null)_2.textMatchStyle="substring";var _3={};_3.exportResults=true;_3.exportAs=_2.exportAs||"csv";_3.exportDelimiter=_2.exportDelimiter||",";_3.exportTitleSeparatorChar=_2.exportTitleSeparatorChar||"";_3.exportFilename=_2.exportFilename||"Results."+_3.exportAs;_2.exportFilename=_3.exportFilename;_3.exportDisplay=_2.exportDisplay||"download";_3.lineBreakStyle=_2.lineBreakStyle||"default";_3.exportFields=this.getExportableDSFields(_2.exportFields||this.getVisibleDSFields());_3.exportHeader=_2.exportHeader;_3.exportFooter=_2.exportFooter;_2.downloadResult=true;_2.downloadToNewWindow=_2.exportDisplay=="window"?true:false;if(_2.downloadToNewWindow){if(_3.exportFilename.endsWith(".xml")&&_3.exportAs!="xml"){_3.exportFilename=_3.exportFilename+".txt"}
...
_1.$376=_1.callback;if(_2=="iscServer"){this.$754(_1);var _3=this.transformRequest(_1);if(this.autoConvertRelativeDates==true){_3=this.convertRelativeDates(_3);_1.data=_3}
var _4=this.getDataProtocol(_1);if(_4=="clientCustom")return;if((!this.clientOnly&&!this.cacheAllData)||_1.cachingAllData){if(this.logIsInfoEnabled("cacheAllData")&&_1.cachingAllData){this.logInfo("sendDSRequest: processing cacheAllData request","cacheAllData")}
return this.performSCServerOperation(_1,_3)}}
var _5=this.getServiceInputs(_1);if(_5.dataProtocol=="clientCustom")return;var _6=isc.addProperties({},_1,_5);_6.$374=_1;if(_5.data==null)_6.data=null;if(this.clientOnly||(this.cacheAllData&&_1.operationType=="fetch")){_6.clientOnly=true;_6.callback={target:this,methodName:"$50e"};isc.RPC.sendRequest(_6);return}
var _7=this.getOperationBinding(_1);_6.transport=_7.dataTransport||this.dataTransport;if(_6.transport=="scriptInclude"){_6.callback={target:this,methodName:"$377"};if(!_6.callbackParam){_6.callbackParam=_7.callbackParam||this.callbackParam}
isc.RPC.sendRequest(_6);return}
var _2=this.getDataFormat(_1);if(_2=="xml"){var _8=_6.spoofedResponse;if(!_8){_6.callback={target:this,method:this.$378};isc.xml.getXMLResponse(_6)}else{var _9=this;isc.Timer.setTimeout(function(){_9.$378(isc.xml.parseXML(_8),_8,{status:0,httpResponseCode:200,data:_8},_6)})}}else if(_2=="json"){_6.callback={target:this,method:this.$379};isc.rpc.sendProxied(_6)}else if(_2=="csv"){_6.callback={target:this,method:this.$69k};isc.rpc.sendProxied(_6)}else{_6.serverOutputAsString=true;_6.callback={target:this,method:this.$38a};isc.rpc.sendProxied(_6)}}
...
,isc.A.$63p=function(){if(!this.autoDeriveTitles)return;for(var _1 in this.fields){var _2=this.fields[_1];if(_2.title!=null)continue;_2.title=this.getAutoTitle(_1);_2.$76s=true}}
...
,isc.A.firstCacheAllDataRequest=function(_1){if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("firstCacheAllDataRequest: refreshing cache","cacheAllData")}
this.$498=[_1];this.cacheResultSet=isc.ResultSet.create({dataSource:this,fetchMode:"local",allRows:this.cacheData?this.cacheData:null,cachingAllData:true,dataArrived:function(_3,_4){this.logWarn("cacheAllData - cacheResultSet.dataArrived: startRow/endRow: "+_3+"/"+_4);if(this.lengthIsKnown()){var _2=this.getDataSource();if(_2.cacheResultSet==null)return;_2.cacheLastFetchTime=new Date().getTime();if(_2.clientOnly)_2.testData=_2.cacheData=this.getAllRows();_2.processDeferredRequests()}}});if(!this.cacheData){if(this.logIsInfoEnabled("cacheAllData")){this.logInfo("firstCacheAllDataRequest: issuing fetch","cacheAllData")}
...
,isc.A.fetchingClientOnlyData=function(_1){if(_1.cachingAllData){return false}
...
,isc.A.getClientOnlyResponse=function(_1,_2){_2=_2||this.testData;if(_2&&!this.testData&&this.clientOnly)
...
,isc.A.applyFilter=function(_1,_2,_3){var _4=[];if(!_1||_1.length==0)return _4;if(this.autoConvertRelativeDates==true){_2=this.convertRelativeDates(_2)}
if(this.isAdvancedCriteria(_2)){return this.recordsMatchingAdvancedFilter(_1,_2,_3)}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+154;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
,isc.A.getCriteriaOperator=function(_1,_2){var _3;if(isc.isA.Number(_1)||isc.isA.Date(_1)){_3="equals"}else if(_2=="equals"||_2=="exact"){_3="iEquals"}else if(_2=="startsWith"){_3="iStartsWith"}else{_3="iContains"}
return _3}
,isc.A.combineCriteria=function(_1,_2,_3,_4){if(!_1)return _2;if(!_2)return _1;if(!_3)_3="and";if(_3!="and"&&_3!="or"){isc.logWarn("combineCriteria called with invalid outerOperator '"+_3+"'");return null}
...
if(!isc.isAn.Array(_62.criteria)){isc.logWarn("AdvancedCriteria: found boolean operator where subcriteria was not "+"an array.  Subcriteria was: "+isc.echoFull(_62.criteria));return false}
...
return true};var _16=function(_59,_60,_61,_62,_63,_64){var _10=_60[_61],_17=_59;if(isc.isA.Number(_10))_10=""+_10;if(!isc.isA.String(_10)){return _63.negate}
...
if(_59.fieldName==_60.fieldName&&_59.value==_60.value&&!_61.equals)
{return 0}
if(_61.equals){if((_52==_53&&!_61.negate)||(_52!=_53&&_61.negate))
{return 0}}
if(_61.startsWith&&!_61.negate&&_53.length>_52.length&&_53.startsWith(_52))
{return 1}
if(_61.startsWith&&_61.negate&&_52.length>_53.length&&_52.startsWith(_53))
{return 1}
if(_61.endsWith&&!_61.negate&&_53.length>_52.length&&_53.endsWith(_52))
{return 1}
if(_61.endsWith&&_61.negate&&_52.length>_53.length&&_52.endsWith(_53))
{return 1}
if(!_61.startsWith&&!_61.endsWith&&!_61.negate&&_53.length>_52.length&&_53.contains(_52))
{return 1}
if(!_61.startsWith&&!_61.endsWith&&_61.negate&&_52.length>_53.length&&_52.contains(_53))
{return 1}
...
if(this.initialData){this.prepareSparseInitialData();this.fillCacheData(this.initialData);this.setFullLength(this.initialLength||this.totalRows||this.initialData.length)}else if(this.isPaged()){this.localData=[]}
...
,isc.A.prepareSparseInitialData=function(){for(var i=0;i<this.initialData.length;i++){if(this.initialData[i]==Array.LOADING)this.initialData[i]=null}}
,isc.A.getFirstDataElement=function(){var _1=this.getFirstUsedIndex();if(this.localData)return this.localData[_1];else return this.get(0)}
,isc.A.getFirstUsedIndex=function(){if(this.localData){for(var i=0;i<this.localData.length;i++){if(this.localData[i]!=null&&this.localData[i]!=Array.LOADING)return i}}
return 0}
...
,isc.A.slideList=function(_1,_2){if(!this.allMatchingRowsCached()&&!this.shouldUpdatePartialCache()){isc.logWarn('updatePartialCache is disabled: record position will not be shifted.');return}
...
if(this.$458==null)this.$458=[];this.$458.add(_2);_4.fetchData(_1,{target:this,methodName:"fetchDataReply"},_3)},fetchDataReply:function(_1,_2,_3){var _4;if(isc.isAn.Array(_2)){_4=_2.get(0)}else{_4=_2}
...
delete _6[_3]}
);isc.B._maxIndex=isc.C+2;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.performSCServerOperation=function(_1,_2){_2=this.serializeFields(_2,_1);_1.oldValues=this.serializeFields(_1.oldValues,_1);var _3=isc.addProperties({},_1);var _4=this.getDataURL(_1);if(_4)_3.actionURL=_4;var _5=_1.operationType;var _6=_3.data=this.prepareDataSourceData(_5,_2,_1);var _7=_1.textMatchStyle;if(_5=="filter"){_5="fetch";if(_7==null)_7="substring"}
...
return isc.EH.STOP_BUBBLING}}
,isc.A.editModeSetDataSource=function(_1,_2,_3){if(isc.$75u){this.baseSetDataSource(_1,_2);return}
...
,isc.A.fieldEdited=function(_1){return _1.editNode.$71u}
,isc.A.getFieldEditNode=function(_1,_2){var _3=this.Class+"Field";var _4={type:_3,autoGen:true,defaults:{name:_1.name,title:_1.title||_2.getAutoTitle(_1.name)}}
return _4}
);isc.B._maxIndex=isc.C+18;isc.A=isc.Class.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSchema=function(){return isc.DS.get(this.schemaName||this.Class)}
...
,isc.A.$40k=function(_1,_2,_3,_4,_5){var _6=_5||this.getObjectField(_2);var _7=this.getSchemaField(_6);if(!_7.multiple){var _8={};_8[_6]=_3;this.logInfo(_1+"ChildObject calling setProperties for fieldName '"+_6+"'","editing");this.setProperties(_8);return true}
...
return false}
,isc.A.editablePropertiesUpdated=function(){if(this.parentElement)this.parentElement.editablePropertiesUpdated()}
...
,isc.A.editablePropertiesUpdated=function(){this.delayCall("manageAddIcon");this.invokeSuper(isc.TabSet,"editablePropertiesUpdated")}
...
,isc.A.getFieldEditNode=function(_1,_2){var _3=this.getEditorType(_1);_3=_3.substring(0,1).toUpperCase()+_3.substring(1)+"Item";var _4={type:_3,autoGen:true,defaults:{name:_1.name,title:_1.title||_2.getAutoTitle(_1.name)}}
return _4}
...
if(isc.TreeGrid!=null){isc.A=isc.TreeGrid.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setEditMode=function(_1,_2,_3){if(_1==null)_1=true;if(_1==this.editingOn)return;this.invokeSuper(isc.TreeGrid,"setEditMode",_1,_2,_3);if(this.editingOn){this.editModeCreateDefaultTreeFieldEditNode();this.saveToOriginalValues(["addField"]);this.setProperties({addField:this.editModeAddField})}else{this.restoreFromOriginalValues(["addField"])}}
,isc.A.editModeCreateDefaultTreeFieldEditNode=function(){if(isc.$75u)return;if(this.dataSource)return;var _1=this.fields;for(var i=0;i<_1.length;i++){if(_1[i].name=="nodeTitle"){var _3={type:"TreeGridField",autoGen:true,defaults:{name:_1[i].name,title:_1[i].title}};var _4=this.editContext.makeEditNode(_3);this.editContext.addNode(_4,this.editNode,null,null,true);return}}}
,isc.A.editModeAddField=function(_1,_2){this.Super("addField",arguments);if(isc.$75u){if(_1.treeField){var _3=this.getFields();for(var i=0;i<_3.length;i++){if(_3[i].name!=_1.name&&_3[i].treeField){this.removeField(_3[i]);break}}}}}
,isc.A.editModeSetDataSource=function(_1,_2,_3){if(isc.$75u){this.baseSetDataSource(_1,_2);return}
...
,isc.A.deselect=function(){isc.SelectionOutline.deselect();this.hideDragHandle()}
...
,isc.A.positionDragHandle=function(_1){if(!this.$70r)return;var _2=this.draggingObject;if(_2.destroyed||_2.destroying){this.logWarn("target of dragHandle: "+isc.echoLeft(_2)+" is invalid: "+_2.destroyed?"already destroyed":"currently in destroy()");return}
...
,isc.A.removeNode=function(_1,_2){return this.removeComponent(_1,_2)}
,isc.A.removeComponent=function(_1,_2){this.data.remove(_1);if(_2)return;var _3=this.data.getParent(_1),_4=this.getLiveObject(_3),_5=this.getLiveObject(_1);isc.DS.removeChildObject(_4,_1.type,_5)}
,isc.A.destroyNode=function(_1){return this.destroyComponent(_1)}
,isc.A.destroyComponent=function(_1){var _2=this.getLiveObject(_1);this.removeNode(_1);if(_2.destroy)_2.destroy()}
...
,isc.A.getField=function(_1){var _2;if(this.dataSource){_2=this.getDataSource().getField(_1)}else{if(this.clause){_2=this.fieldData?this.fieldData[_1]:null;if(!_2)_2=this.clause.getField("fieldName").getSelectedRecord();if(!_2)_2=this.field;else this.field=_2}}
return _2}
...
,isc.A.buildValueItemList=function(_1,_2){if(_2==null)this.logWarn("buildValueItemList passed null operator");if(_1==null)return;var _3=_1.name,_4=_2?_2.valueType:"text",_5=isc.SimpleType.getType(_1.type)||isc.SimpleType.getType("text"),_6=[],_7,_8=null;while(_5.inheritsFrom){_5=isc.SimpleType.getType(_5.inheritsFrom)}
...
if(_1.editorType=="SelectItem"||_1.editorType=="ComboBoxItem"){if(_1.editorProperties!=null){_7=_1.editorProperties;_9=isc.addProperties(_9,{optionDataSource:_7.optionDataSource?_7.optionDataSource:this.getDataSource(),valueField:_7.valueField?_7.valueField:_1.name,displayField:_7.displayField?_7.displayField:_1.name})}}
...
{return null}
return _7}
,isc.A.setDefaultFocus=function(){if(!this.clause)return;if(isc.isA.Function(this.clause.focusInItem))this.clause.focusInItem("fieldName")}
...
,isc.A.fieldNameChanged=function(){this.clause.getItem("operator").disabled=false;this.updateFields()}
...
);isc.B._maxIndex=isc.C+22;isc.FilterClause.registerStringMethods({remove:""});isc.defineClass("FilterBuilder","Layout");isc.A=isc.FilterBuilder;isc.A.missingFieldPrompt="[missing field definition]";isc.A=isc.FilterBuilder;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getFilterDescription=function(_1,_2){if(!isc.isA.DataSource(_2))_2=isc.DS.getDataSource(_2);if(!_2)return"No dataSource";var _3="";if(_1.criteria&&isc.isAn.Array(_1.criteria)){var _4=_1.operator,_5=_1.criteria;for(var i=0;i<_5.length;i++){var _7=_5[i];if(i>0)_3+=" "+_4+" ";if(_7.criteria&&isc.isAn.Array(_7.criteria)){_3+="("
...
,isc.A.removeClause=function(_1){this.clauses.remove(_1);if(this.clauseStack)this.clauseStack.hideMember(_1,function(){_1.destroy()});this.updateFirstRemoveButton()}
...
this.addAutoChild("clauseStack");this.clauseStack.hide();if(_2=="radio"){this.addAutoChild("radioOperatorForm");var _8={};for(var i=0;i<this.radioOptions.length;i++){_8[this.radioOptions[i]]=_4[this.radioOptions[i]]}
...
,isc.A.addNewClause=function(_1,_2){var _3=this.createAutoChild("clause",{visibility:"hidden",flattenItems:true,criterion:_1,dataSource:this.dataSource,validateOnChange:this.validateOnChange,showFieldTitles:this.showFieldTitles,showRemoveButton:this.showRemoveButton,removeButtonPrompt:this.removeButtonPrompt,retainValuesAcrossFields:this.retainValuesAcrossFields,fieldDataSource:this.fieldDataSource,field:_2,fieldData:this.fieldData,fieldPickerDefaults:this.fieldPickerDefaults,fieldPickerProperties:this.fieldPickerProperties,remove:function(){this.creator.removeClause(this)},fieldNameChanged:function(){this.Super("fieldNameChanged",arguments);this.creator.fieldNameChanged(this)}});return this.$74e(_3)}
,isc.A.addClause=function(_1){if(!_1)return _1;var _2=this;_1.fieldDataSource=this.fieldDataSource;_1.remove=function(){_2.removeClause(this)};_1.fieldNameChanged=function(){this.Super("fieldNameChanged",arguments);_2.fieldNameChanged(this)};return this.$74e(_1)}
,isc.A.$74e=function(_1){this.clauses.add(_1);var _2=this.clauseStack;var _3=Math.max(0,_2.getMemberNumber(this.buttonBar));_2.addMember(_1,_3);_2.showMember(_1,function(){_1.setDefaultFocus()});this.updateFirstRemoveButton();return _1}
...
return _1}
,isc.A.getFieldOperators=function(_1){var _2=this.getPrimaryDS().getField(_1);return this.getPrimaryDS().getFieldOperators(_2)}
,isc.A.getValueFieldProperties=function(_1,_2){}
...
return isc.clone(_1)}
,isc.A.filterReady=function(){}
,isc.A.setCriteria=function(_1){this.clearCriteria(true);if(!this.$76t&&this.fieldDataSource&&_1){if(isc.isA.String(this.fieldDataSource))
...
,isc.A.fetchFieldsReply=function(_1,_2){if(this.fieldData){var _3=isc.getValues(this.fieldData);_3.addList(_1.data);this.fieldData=_3.makeIndex("name")}else this.fieldData=_1.data.makeIndex("name");this.setCriteria(_2)}
,isc.A.clearCriteria=function(_1){var _2=this.clauseStack?this.clauseStack.animateMembers:null;if(this.clauseStack)this.clauseStack.animateMembers=false;while(this.clauses.length>0){this.removeClause(this.clauses[0])}
if(!_1&&!this.allowEmpty)this.addNewClause();if(this.clauseStack)this.clauseStack.animateMembers=_2}
,isc.A.addCriterion=function(_1,_2){if(_1.criteria){var _3=this.addSubClause(_1);for(var _4=0;_4<_1.criteria.length;_4++){_2=this.fieldData?this.fieldData[_1.criteria[_4].fieldName]:null;_3.addCriterion(_1.criteria[_4],_2)}}else{this.addNewClause(_1,_2)}}
...
,isc.A.getEditorType=function(_1,_2){var _3=this.getPrimaryDS(),_4,_5;var _6=_3.getSearchOperator(_2);if(_6.editorType)return _6.editorType;if(_6.getEditorType&&isc.isA.Function(_6.getEditorType))
...
);isc.B._maxIndex=isc.C+31;isc.FilterBuilder.registerStringMethods({search:"criteria",filterChanged:""})}
...
,isc.A.setButtonTitles=function(_1){if(this.addLevelButton)this.addLevelButton.setTitle(this.addLevelButtonTitle);if(this.deleteLevelButton)this.deleteLevelButton.setTitle(this.deleteLevelButtonTitle);if(this.copyLevelButton)this.copyLevelButton.setTitle(this.copyLevelButtonTitle)}
...
,isc.A.setSortFields=function(){var _1=[];this.optionsGrid.getField("property").title=this.propertyFieldTitle;if(!this.fields)return;for(var i=0;i<this.fields.length;i++){var _3=this.fields[i];if(_3.canSort!=false)_1.add(_3)}
