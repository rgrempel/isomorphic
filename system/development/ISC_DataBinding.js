...
);isc.evalBoundary;isc.B.push(isc.A.addData=function(_1,_2,_3){this.performDSOperation("add",_1,_2,_3)}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+152;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{return null}}
...
_4=_10.defaultValue}
if(_4){var _6=this.field||this.getField(_4);var _12=_6?this.getFieldOperatorMap(_6,false,"criteria",true):null;_11.valueMap=_12;if(_12){if(_2&&_2.operator){_11.defaultValue=_2.operator}else{_11.defaultValue=isc.firstKey(_12)}}
this.$74o=_4;var _13=this.getSearchOperator(_11.defaultValue);if(!_13&&_12.length>0){isc.logWarn("Criterion specified unknown operator "+(_2?_2.operator:"[null criterion]")+". Using the first valid operator ("+isc.firstKey(_12)+") instead");_11.defaultValue=isc.firstKey(_12);_13=this.getSearchOperator(_11.defaultValue)}
...
if(_14)_1.addList(_14)}else{_11.disabled=true}
this.addAutoChild("clause",{flattenItems:this.flattenItems,items:_1})}
...
,isc.A.getCriterion=function(){if(!this.clause)return null;var _1=this.clause,_2;_2=_1.getValues();if(this.fieldName)_2.fieldName=this.fieldName;if(isc.isA.Date(_2.value))_2.value.logicalDate=true;var _3=_2.operator;if(isc.isA.String(_3))_3=this.getSearchOperator(_3);if(!_3||(_3.valueType!="none"&&_3.valueType!="valueRange"&&(_2.value==null||(isc.isA.String(_2.value)&&_2.value==""))))
{return null}
return _2}
...
,isc.A.setCriteria=function(_1){this.clearCriteria(true);if(this.$75v&&!this.fieldData){if(isc.isA.String(this.fieldDataSource))
...
delete this.$75v;this.clauseStack.show();this.redraw();this.filterReady()}
,isc.A.fetchFieldsReply=function(_1,_2){this.fieldData=_1.data;this.setCriteria(_2)}
...
);isc.B._maxIndex=isc.C+30;isc.FilterBuilder.registerStringMethods({search:"criteria",filterChanged:""})}
...
(function(){var _1={Button:"button",StretchImgButton:"button",ImgButton:"button",Label:"label",CheckboxItem:"checkbox",Slider:"slider",ComboBoxItem:"combobox",SelectItem:"listbox",Window:"dialog",Toolbar:"toolbar",TabBar:"tablist",PaneContainer:"tabpanel",ImgTab:"tab",EdgedCanvas:"presentation",BackMask:"presentation"}
