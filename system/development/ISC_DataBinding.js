...
_2[_3]=_4}
return _2}
,isc.A.checkEmptyCriteria=function isc_c_DataSource_checkEmptyCriteria(_1){if(_1.criteria){if(_1.criteria.length==0)return null;for(var i=_1.criteria.length;i>=0;i--){var _3=_1.criteria[i];if(_3&&_3.criteria){var _4=this.checkEmptyCriteria(_3);if(_4)_1.criteria[i]=_4;else _1.criteria.removeAt(i)}}}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+163;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
_1.$374=_1;this.delayCall("$50h",[_3,_3.data,_1],0);return true;}else if(_2.useOfflineCache||_2.useOfflineCacheOnly){var _3=isc.Offline.getResponse(_2);if(_3!=null){if(this.useOfflineResponse&&!this.useOfflineResponse(_2,_3))
{this.logInfo("User-written useOfflineResponse() method returned"+" false; not using cached response","offline");_3=null}}
if(_3!=null){_1.$374=_1;this.delayCall("$50h",[_3,_3.data,_1],0);return true}else if(_1.useOfflineCacheOnly){_3={status:isc.RPCResponse.STATUS_OFFLINE,data:[]}
_1.$374=_1;this.delayCall("$50h",[_3,_3.data,_1],0);return true}}}}
return false}
