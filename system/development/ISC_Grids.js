...
,isc.A.setFieldState=function(_1){if(isc.isA.String(_1))_1=this.evalViewState(_1,"fieldState");var _2=this.$31y(_1);this.setFields(_2);this.markForRedraw()}
,isc.A.getFieldState=function(_1){var _2=[];var _3=this.getAllFields();if(_3){for(var i=0;i<_3.length;i++){var _5=_3[i],_6=_5[this.fieldIdProperty],_7={name:_6};if(!this.fieldShouldBeVisible(_5))_7.visible=false;if(_5.userFormula)_7.userFormula=_5.userFormula;if(_5.userSummary)_7.userSummary=_5.userSummary;if(_1||_5.userSummary||_5.userFormula){_7.title=_5.title}
_2.add(_7)}}
...
,isc.A.hideField=function(_1){this.getField(_1).showIf="false";this.getField(_1).hidden=true}
,isc.A.showField=function(_1){this.getField(_1).showIf="true";this.getField(_1).hidden=false}
...
for(_1=_13;_1<_14;_1++){if(_64&&_63.$52e&&_57&&_1==_58)_1++;var _67=_18[_1],_68=_63;if(_68==null)_68=this.getCellRecord(_61,_1);if(_54[_1]>0){_67.$28w[_61]=_56[_1];_54[_1]--;if(_54[_1]==0){_55--;_56[_1]=null}
continue}
_37[_40]=this.getCellAlign(_63,_67,_61,_1);var _69=this.getCellVAlign(_63,_67,_61,_1);if(_69!=null){_37[_41]=_53
_37[_42]=_69}
if(_64&&(!_57||_1!=_58))
{_35++;_37[_43]=_63.$52e?_60:_59;if(_36){_37[_48+1]=this.$ob}}else{_37[_43]=_67.$28x;if(this.getRowSpan){var _70=this.getRowSpan(_63,_61,_1);if(_70>1){var _71=" ROWSPAN="+_70;if(_37[_40]!=null)
_37[_40]+=_71;else
...
if(_64){if(!_57)break;if(_58>=_1)_1+=_15-_63.$52e?1:2}}
...
var _14=this.getRowTop(_2),_15=_7!=null?this.getColumnLeft(_7):0,_16=_13!=null?_13:_1.getHeight(),_17=_12!=null?_12:_1.getWidth();if(_13||_12){_1.resizeTo(_12,_13);_1._percent_width=_10;_1._percent_height=_11}
isc.Canvas.snapToEdge([_15,_14,_9,_8],_5,_1,_6)}else{_1.setTop(this.getRowTop(_2)+this.cellHeight)}
...
var _2=this.$60z(),_3=(_2!=null&&this.fields?this.fields[_2]:null);var _4=this.$30a,_5=this.getEditRow(),_6=this.getEditCol(),_7=this.$286,_8=this.fields?this.getEditFieldName():null;if(this.completeFields==null)this.fields=[];this.completeFields=this.bindToDataSource(_1);if(this.completeFields==null)this.completeFields=[];if(this.selectionAppearance=="checkbox"&&this.selectionType!="none"){var _9=this.getCheckboxField(),_10=this.getCheckboxFieldPosition();if(this.completeFields.find("frozen",true))_9.frozen=true;this.completeFields.addAt(_9,_10);this.freezeField(_9)}
...
for(var i=0;i<this.completeFields.length;i++){var _6=this.completeFields[i],_7=_6[this.fieldIdProperty],_8={name:_7};if(!this.fieldIsVisible(_6))_8.visible=false;if(_1||_6.userSummary||_6.userFormula){_8.title=_6.title}
if(_3){var _9=_3.find(this.fieldIdProperty,_7);if(!_9&&_4){_9=_4.find(this.fieldIdProperty,_7)}
if(_9&&_9.$pn&&isc.isA.Number(_9.$pn)){_8.width=_9.$pn}}
if(_6.userFormula)_8.userFormula=_6.userFormula;if(_6.userSummary)_8.userSummary=_6.userSummary;_2.add(_8)}}
return isc.Comm.serialize(_2)}
...
return _3}
,isc.A.getSpecificFieldValue=function(_1,_2){var _3=this.getRecordIndex(_1),_4=this.getSpecifiedField(_2),_5=this.fields.contains(_4),_6;if(_5){return this.getCellValue(_1,_3,this.getFieldNum(_2),this.body)}else if(_4.userFormula){return this.getFormulaFieldValue(_4,_1)}else if(_4.userSummary){return this.getSummaryFieldValue(_4,_1)}
return this.getRawCellValue(_1,_3,_2,true)}
...
);isc.evalBoundary;isc.B.push(isc.A.selectRecordForEdit=function(_1){if(!this.editByCell)_1.$29m=true;if(this.canSelectCells){var _2=this.getRecordCellIndex(_1);this.selection.selectSingleCell(_2[0],_2[1])}else{this.selection.selectSingle(_1)}
delete _1.$29m}
...
if(this.editByCell){this.refreshCell(_1,_2)}else{var _6=this.getDrawnFields();for(var i=0;i<_6.length;i++){if(this.isCheckboxField(_6[i]))continue;var _8=_6[i][this.fieldIdProperty],_9=this.$286.getItem(_8);_2=_9.colNum,formItemVisible=!!(_3&&_9.isDrawn()),canEditCell=this.canEditCell(_1,_2);if(formItemVisible!=canEditCell)this.refreshCell(_1,_2);else if(this.selectOnEdit||this.lastOverRow){var _5=this.getField(_8).frozen?this.frozenBody:this.body;_5.$29h(this.getCellRecord(_1,_2),_1,_2)}}}}
...
);isc.evalBoundary;isc.B.push(isc.A.rowEditNotComplete=function(_1){return(this.$33a!=null&&this.$33a[_1]!=null)}
...
return _4}
);isc.evalBoundary;isc.B.push(isc.A.getTotalRows=function(){if(this.data==null)return 0;var _1=this.data.getLength(),_2=this.$34e();if(_2!=null&&_2+1>_1)_1=_2+1;if(this.showNewRecordRow)_1+=1;return _1}
...
,isc.A.headerClick=function(_1,_2){var _3=_2.getMember(_1).masterIndex,_4=this.fields[_3];if(this.isCheckboxField(_4)&&this.selectionType!="single"){if(_4.$63h){this.deselectAllRecords();this.$63m(false)}else{this.selectAllRecords();if(!isc.ResultSet||!isc.isA.ResultSet(this.data)||this.data.allMatchingRowsCached()){this.$63m(true)}}
return false}
if(this.canSort==false||!_4||this.$66c(_4)==false)return false;if(_3==this.$60z()){if(this.canUnsort&&_4.sortDirection!=isc.ListGrid.getInstanceProperty("sortDirection")){this.unsort()}else{var _5=_4.sortDirection==null?this.sortDirection:_4.sortDirection;this.sort(_3,!Array.shouldSortAscending(_5))}}else{this.sort(_3)}
return false}
...
if(_2){if(this.canFreezeFields&&this.fields.length>1&&(_2.frozen||(this.frozenFields==null||this.normalFields.length>1))&&!(this.spanMap&&this.spanMap[_2.name]))
...
,isc.A.unsort=function(){if(this.data.unsort&&(this.data.unsort()||this.canUnsort)){var _1=this.$60z();this.$600(null);if(_1!=null&&this.header&&isc.isA.Toolbar(this.header)){this.header.deselectButton(_1);var _2=this.header.getButton(_1);if(_2)_2.setTitle(this.getHeaderButtonTitle(_2))}
...
);isc.B._maxIndex=isc.C+65;isc.TreeGrid.registerStringMethods({folderOpened:"node",folderClosed:"node",folderClick:"viewer,folder,recordNum",leafClick:"viewer,leaf,recordNum",nodeClick:"viewer,node,recordNum",folderContextClick:"viewer,folder,recordNum",leafContextClick:"viewer,leaf,recordNum",nodeContextClick:"viewer,node,recordNum",dataArrived:"parentNode"});isc.ClassFactory.defineClass("ButtonStrip","GridRenderer");isc.A=isc.ButtonStrip.getPrototype();isc.A.buttons=[];isc.A.buttonDefaults={};isc.A.buttonSpacing=3;isc.A.buttonPadding=2;isc.A.defaultButtonHeight=20;isc.A.defaultButtonWidth=100;isc.A.vertical=false;isc.A.overflow=isc.Canvas.VISIBLE;isc.A.showRollOver=true;isc.A.useCellRollOvers=true;isc.A.canDrag=false;isc.A.canDragSelect=false;isc.A.canSelectCells=false;isc.A.fastCellUpdates=true;isc.A.titleAlign="center";isc.A.fillSpace=false;isc.A.backgroundColor=null;isc.A.baseStyle="button";isc.A=isc.ButtonStrip.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function(){this.Super(this.$oc);if(this.buttonPadding!=null)this.cellPadding=this.buttonPadding;if(this.buttonSpacing!=null)this.cellSpacing=this.buttonSpacing;var _1=[];for(var i=0;i<this.buttons.length;i++){this.buttons[i]=isc.addProperties({},this.buttonDefaults,this.buttons[i]);if(this.vertical)_1[i]=this.buttons[i].height}
...
_15+=_23+_19}}else{this.logDebug("starting fit layout","TileLayout");var _28=this.getTilesPerLine();var _29=this.getTileHeight();var _30=this.getTileWidth();var _13=this.orientation=="horizontal";var _31,_32,_33;var _34,_35,_36,_37,_38,_39;if(this.shouldUseIncrRendering()){var _40=this.getVisibleTiles();this.$57r=_40;_35=_40[0];_34=_11;var _41=this.getVisibleLines();_38=_41[0];_39=_41[0]+_41[1]}else{_34=_11;_35=0;_38=0;_39=Math.ceil(_34/ _28);_31=this.getTileHMargin();_32=this.getTileVMargin()}
...
_2=this.getAllFields();for(var _5 in _2){var _4=_2[_5];if(_4[this.fieldIdProperty]==_1)return _4}
return null}
,isc.A.getFields=function(){return this.fields}
,isc.A.getAllFields=function(){if(this.dataSource){var _1=this.getDataSource().getFields(),_2=this.getFields(),_3=[];for(var _4 in _1){_3.add(_1[_4])}
if(_2){for(var i=0;i<_2.length;i++){var _6=_2.get(i);if(!_3.find(this.fieldIdProperty,_6[this.fieldIdProperty])){_3.add(_6)}}}
return _3}else return this.getFields()}
,isc.A.setFieldState=function(_1){if(isc.isA.String(_1))_1=this.evalViewState(_1,"fieldState")
if(_1){this.completeFields=this.$31y(_1);this.setFields(_1);this.markForRedraw()}}
,isc.A.getFieldState=function(){var _1=[],_2=this.getFields();if(_2){for(var i=0;i<_2.length;i++){var _4=_2[i],_5=_4[this.fieldIdProperty],_6={name:_5};if(_4.userFormula)_6.userFormula=_4.userFormula;if(_4.userSummary)_6.userSummary=_4.userSummary;_1.add(_6)}}
return isc.Comm.serialize(_1)}
);isc.B._maxIndex=isc.C+44;isc.ClassFactory.defineClass("SimpleTile","StatefulCanvas");isc.A=isc.SimpleTile.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.baseStyle="simpleTile";isc.A.overflow="hidden";isc.A.showRollOver=true;isc.A.redrawOnStateChange=true;isc.B.push(isc.A.initWidget=function(){this.invokeSuper(isc.SimpleTile,"initWidget",arguments);this.showDown=this.creator.valuesShowDown}
...
,isc.A.showHelpWindow=function(){var _1=this.locatorParent;_1.centerInPage();if(this.helpWindow&&this.helpWindow!=null){this.hideHelpWindow()}else{this.helpIcon.prompt=null;this.formulaField.stopHover();_1.setLeft(_1.left-(_1.width/ 2));this.helpWindow=isc.Window.create({autoDraw:true,title:this.builderTypeText+" Help",showMinimizeButton:false,showMaximizeButton:false,showCloseButton:false,isModal:false,headerIconProperties:{src:"[SKIN]actions/help.png"},items:[isc.Label.create({contents:this.getHelpText(),padding:10})]});this.helpWindow.moveTo(_1.getLeft()+_1.getWidth(),_1.getTop());this.helpWindow.resizeTo(_1.getWidth(),_1.getVisibleHeight())}}
...
,isc.A.getCompleteValueObject=function(){var _1=this.getUsedFields(),_2=this.generateFunction(),_3={sortNormalizer:_2,$65w:_2,userFormula:{text:this.getValue(),formulaVars:{}}};if(this.allowEscapedKeys)_3.userFormula.allowEscapedKeys=true;for(var i=0;i<_1.length;i++){var _5=_1.get(i);_3.userFormula.formulaVars[_5.mappingKey]=_5[this.component.fieldIdProperty]}
return _3}
,isc.A.getBasicValueObject=function(){var _1=this.getUsedFields(),_2={text:this.getValue(),formulaVars:{}};if(this.allowEscapedKeys)_2.allowEscapedKeys=true;for(var i=0;i<_1.length;i++){var _4=_1.get(i);_2.formulaVars[_4.mappingKey]=_4[this.component.fieldIdProperty]}
return _2}
,isc.A.getUpdatedFieldObject=function(){return isc.addProperties(this.field,{title:this.getTitle()},this.getCompleteValueObject())}
,isc.A.testFunction=function(){var _1=this.getClass().testFunction(this.field,this.getBasicValueObject(),this.component,this.getUsedFields());if(_1.failedGeneration||_1.failedExecution){this.setTestMessage("Invalid "+this.builderTypeText+": "+_1.errorText)}else if(_1.emptyTestValue){this.setTestMessage("Invalid blank "+this.builderTypeText)}else{this.setTestMessage("Valid "+this.builderTypeText)}
this.setSamplePrompt(this.getSamplePrompt(_1));return _1}
,isc.A.getTestRecord=function(){if(this.testRecord)return this.testRecord;return this.getClass().getTestRecord(this.component)}
...
,isc.A.doneEditing=function(){var _1=this.testFunction();if(_1.emptyTestValue){isc.warn("Invalid blank "+this.builderTypeText+".");return}else if(_1.failedGeneration||_1.failedExecution){isc.warn("The generated function is invalid - Check your "+this.builderTypeText+" and retry.");return}
...
,isc.A.getSamplePrompt=function(_1){var _2=this.dataSource.getTitleField(),_3=_1.result||"Invalid "+this.builderTypeText,_4=this.component.getTitleFieldValue(_1.record);return this.samplePrompt.evalDynamicString(this,{title:_4,output:_3})}
);isc.B._maxIndex=isc.C+28;isc.A=isc.FormulaBuilder;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.mappingKeyForIndex=function(_1){var _2="";var _3=Math.floor(_1/ 26);for(var i=0;i<_3;i++)_2+="A";_2+=String.fromCharCode(65+_1%26);return _2}
,isc.A.getAvailableFields=function(_1){var _2=[];if(!_1)return _2;for(var i=0,j=0;i<_1.getLength();i++){var _5=_1.get(i),_6=_5.type;if(!_5.hidden&&(isc.SimpleType.inheritsFrom(_6,"integer")||isc.SimpleType.inheritsFrom(_6,"float")))
...
return _4}
,isc.A.getUsedFieldsFromValue=function(_1,_2,_3){var _4=_1,_5=[];for(var _6 in _4){var _7=_4[_6],_8=_2.findIndex("name",_7);if(!_2[_8]){isc.logWarn("Field "+_7+" is not in the list of available-fields")}else{var _9=isc.clone(_2[_8]);_9.mappingKey=_6;_5.add(_9)}}
return _5}
,isc.A.testFunction=function(_1,_2,_3,_4){var _5={};try{_5.component=_3;_5.record=this.getTestRecord(_3);if(_2.text==""){_5.emptyTestValue=true;return _5}
...
return _5}
,isc.A.getTestRecord=function(_1){var _2=_1.getSelectedRecord();if(!_2){if(_1.body){var _3=_1.body.getVisibleRows();_2=_3?_1.getRecord(_3[0]):_1.data.get(0)}else{_2=_1.data.get(0)}}
if(!_2){var _4=this.getUsedFields();_2={};for(var i=0;i<_4.length;i++){var _6=_4.get(i);_2[_6[_1.fieldIdProperty]]=1}}
return _2}
,isc.A.generateFunction=function(_1,_2,_3){var _4=isc.SB.create(),_5=_1.text,_6=this.getUsedFieldsFromValue(_1.formulaVars,_2,_3);_6=_6.sortByProperties(["mappingKey"],[false]);if(_6.length>0){_4.append("var ");for(var i=0;i<_6.length;i++){var _8=_6.get(i);if(i>0)_4.append("        ");_4.append(_8.mappingKey,"=record.",_8[_3.fieldIdProperty]);_4.append(i==_6.length-1?";":",","\n");if(_1.allowEscapedKeys){_5=_5.replaceAll("#"+_8.mappingKey,_8.mappingKey);_5=_5.replaceAll("#{"+_8.mappingKey+"}",_8.mappingKey)}}
_4.append("\n")}
var _9=isc.MathFunction.getRegisteredFunctions();if(_9.length>0){_4.append("var functions=isc.MathFunction.getRegisteredFunctionIndex(),\n");for(var i=0;i<_9.length;i++){var _8=_9.get(i);_4.append("        ");_4.append(_8.name,"=","functions.",_8.name,".jsFunction");_4.append(i==_9.length-1?";":",","\n")}
_4.append("\n")}
_4.append("return ",_5,";");var _10=_4.toString();var _11=new Function("record",_10);return _11}
);isc.B._maxIndex=isc.C+7;isc.ClassFactory.defineClass("SummaryBuilder","FormulaBuilder");isc.A=isc.SummaryBuilder.getPrototype();isc.A.builderTypeText="Summary";isc.A.autoHideCheckBoxLabel="Auto hide fields used in Summary";isc.A.helpTextIntro="Building Summary Columns";isc.A.allowBasicMultiCharKeys=false;isc.A=isc.SummaryBuilder.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setInitialValue=function(){if(this.editMode&&this.field.userSummary){this.initialValue=this.field.userSummary.text}
this.initialValue=this.initialValue||"";this.setValue(this.initialValue)}
,isc.A.getHoverText=function(){var _1=isc.SB.create(),_2=this.getTestRecord(),_3=this.getFieldFromMappingKey("A"),_4=_3[this.component.fieldIdProperty],_5=_3.title,_6=this.getFieldFromMappingKey("B"),_7=_6?_6[this.component.fieldIdProperty]:null,_8=_6?_6.title:null;_1.append("<b>",this.helpTextIntro,"</b> <P>");_1.append("Summary columns are user-created fields that combine dynamic-values "+"from other fields in the current record with static text specified by the user.<P>");_1.append("Dynamic-values are specified by prefixing a mapping-key from the table "+"opposite with #");if(this.getFields().length>26)_1.append(", or by using #{key} when the key "+"is 2 or more characters long,");_1.append(" and everything else is copied directly into the output.<P>");if(this.dataSource){_1.append("For example, in the current DataSource, key <b>A</b> maps to field <i>",_5,"</i> and <b>B</b> is <i>",!_6?"missing":_8,"</i>.<P>");_1.append("So, if we enter the Summary format-string as:<P>","<i>#A is relative to #B</i><P>","then example output using the current data would look like:<P>");if(_2){_1.append("<i>",_2[_4]," is relative to ",!_6?"{missing}":_2[_7],"</i><P>")}}
return _1.toString()}
,isc.A.getAvailableFields=function(){return this.getClass().getAvailableFields(this.getFields())}
...
,isc.A.getCompleteValueObject=function(){var _1=this.getUsedFields(),_2=this.generateFunction(),_3={sortNormalizer:_2,$652:_2,userSummary:{text:this.getValue()}};if(_1&&_1.length>0){_3.userSummary.summaryVars={};for(var i=0;i<_1.length;i++){var _5=_1.get(i);_3.userSummary.summaryVars[_5.mappingKey]=_5[this.component.fieldIdProperty]}}
return _3}
,isc.A.getBasicValueObject=function(){var _1=this.getUsedFields(),_2={text:this.getValue(),summaryVars:{}};for(var i=0;i<_1.length;i++){var _4=_1.get(i);_2.summaryVars[_4.mappingKey]=_4[this.component.fieldIdProperty]}
return _2}
,isc.A.generateFunction=function(){return this.getClass().generateFunction(this.getBasicValueObject(),this.getUsedFields(),this.component)}
,isc.A.initWidget=function(){this.Super("initWidget",arguments)}
);isc.B._maxIndex=isc.C+8;isc.A=isc.SummaryBuilder;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getAvailableFields=function(_1){var _2=[];if(!_1)return _2;for(var i=0,j=0;i<_1.getLength();i++){var _5=_1.get(i);if(!_5.hidden&&!_5.userSummary){_5.mappingKey=isc.FormulaBuilder.mappingKeyForIndex(j++);_2.add(_5)}}
return _2}
...
return _5}
,isc.A.getUsedFieldsFromValue=function(_1,_2,_3){var _4=_1,_5=[];for(var _6 in _4){var _7=_4[_6],_8=_2.findIndex(_3.fieldIdProperty,_7);if(!_2[_8]){isc.logWarn("Field "+_7+" is not in the list of available-fields")}else{var _9=isc.clone(_2[_8]);_9.mappingKey=_6;_5.add(_9)}}
return _5}
,isc.A.testFunction=function(_1,_2,_3,_4){var _5={};try{_5.component=_3;_5.record=this.getTestRecord(_3);if(_2.text==""){_5.emptyTestValue=true;return _5}
_5.jsFunction=this.generateFunction(_2,_4,_3);_5.result=_5.jsFunction(_5.record,_1[_3.fieldIdProperty],_3)}catch(err){if(!_5.jsFunction)_5.failedGeneration=true;_5.failedExecution=true;_5.errorText=err.message}
return _5}
,isc.A.generateFunction=function(_1,_2,_3){var _4=isc.SB.create(),_5=_1.text,_6=this.getUsedFieldsFromValue(_1.summaryVars,_2,_3);_6=_6.sortByProperties(["mappingKey"],[false]);if(_6.length>0){_4.append("var ");for(var i=0;i<_6.length;i++){var _8=_6.get(i);if(i>0)_4.append("        ");_4.append(_8.mappingKey,"=component.getSpecificFieldValue(record,'",_8[_3.fieldIdProperty],"'");_4.append(i==_6.length-1?");":"),","\n");_5=_5.replaceAll("#{"+_8.mappingKey+"}","'+"+_8.mappingKey+"+'");_5=_5.replaceAll("#"+_8.mappingKey,"'+"+_8.mappingKey+"+'")}
_4.append("\n")}
...
_4.append("return ",_5,";");var _9=_4.toString(),_10=new Function("record,fieldName,component",_9);return _10}
