...
else isc._preLog=[isc._pTM]}isc.definingFramework=true;isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.applyTableResizePolicy=function(_1,_2,_3,_4,_5,_6,_7){var _8=this.logIsDebugEnabled("tablePolicy"),_9=this.logIsInfoEnabled("tablePolicy"),_10=this.logIsDebugEnabled("tablePlacement");var _11=_1.$8j;if(!this.$8k(_1)){_11=_1.$8j=[];var _12=0,_13=0;for(var _14=0;_14<_1.length;_14++){var _15=_1[_14];if(!_15.alwaysTakeSpace&&!_15.visible)continue;var _16=_15.getColSpan(),_17=_15.getRowSpan();if(_17==0||_16==0)continue;if(_16==null)_16=1;if(_17==null)_17=1;var _18=_16;if(_16=="*")_18=1;var _19=_15.getTitleOrientation();if(_15.showTitle&&(_19==isc.Canvas.LEFT||_19==isc.Canvas.RIGHT))
{_18+=1;if(_16!="*")_16+=1}
...
,isc.A.showYearMenu=function(){if(!this.yearMenu){var _1=[[]],_2=(this.endYear-this.startYear),_3=Math.round(_2/ 10)>3?Math.round(_2/ 10):3;for(var i=0;i<=(this.endYear-this.startYear);i++){var _5=i+this.startYear;_1[_1.length-1].add({contents:_5,action:this.getID()+".showYear("+_5+")"});if((i+1)%_3==0)_1.add([])}
...
return this.Super("editorKeyPress",arguments)}});isc.A=isc.ScrollingMenu.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.show=function(){if(this.showModal)this.showClickMask({target:this,methodName:"cancel"},false,[this]);this.Super("show",arguments);if(this.showModal)this.body.focus()}
,isc.A.recordClick=function(_1,_2,_3,_4,_5,_6,_7){this.hide();if(_2!=null)this.itemClick(_2)}
,isc.A.itemClick=function(_1){}
,isc.A.rowOver=function(_1,_2,_3){if(this.enableSelectOnRowOver)this.selection.selectOnRowOver(_1)}
...
,isc.A.setValues=function(_1,_2){delete this.$76u;if(isc.isAn.Array(_1)){var _3=isc.isA.Object(_1[0]);this.logWarn("values specified as an array."+(_3?" Treating the first item in the array as intended values.":" Ignoring specified values (resetting to defaults)."));if(_3)_1=_1[0];else _1=null}
...
,isc.A.getValuesAsCriteria=function(_1,_2){if(_1==null){_1=(this.operator!="and")||this.getItems().map("hasAdvancedCriteria").contains(true)||(this.$76u!=null)}
if(!_1){var _3=this.$76v();if(_2)return _3;return isc.DataSource.filterCriteriaForFormValues(_3)}
var _4=this.$76u?isc.clone(this.$76u):{operator:this.operator,_constructor:"AdvancedCriteria",criteria:[]};var _5=this.$76v(true);_4.criteria.addList(_5);return _4}
,isc.A.$76v=function(_1){var _2=isc.addProperties({},this.getValues()),_3={},_4=[];var _5=this.getFields();for(var i=0;i<_5.length;i++){if(!_5[i].shouldSaveValue)continue;var _7=_5[i],_8=_5[i].getFieldName(),_9=_5[i].getCriteriaFieldName();delete _2[_8];if(!_1){if(_9!=null){_3[_9]=_5[i].getCriteriaValue()}}else{var _10=_7.getCriterion();if(_10!=null)_4.add(_10)}}
if(!_1){return isc.addProperties(_2,_3)}else{for(var _11 in _2){if(_4.find("fieldName",_11))continue;_4.add({operator:"equals",fieldName:_11,value:_2[_11]})}
return _4}}
,isc.A.getFilterCriteria=function(){return this.getValuesAsCriteria()}
,isc.A.setValuesAsCriteria=function(_1,_2){if(!_2&&!isc.DataSource.isAdvancedCriteria(_1)){this.setValues(_1)}else{this.setValues({});_1=isc.clone(_1);var _3=_1.operator;if(_3!=this.operator){this.logWarn("Dynamic Form editing advanced criteria object:"+isc.Comm.serialize(_1)+". Form level operator specified as '"+this.operator+"' - Criteria returned from this form will be nested in an outer "+this.operator+" clause.");_1._constructor=null;_1={_constructor:"AdvancedCriteria",operator:this.operator,criteria:[_1]}}
var _4=this.getItems(),_5={},_6=_1.criteria;for(var i=0;i<_6.length;i++){for(var _8=0;_8<_4.length;_8++){if(!_4[_8].shouldSaveValue)continue;if(_4[_8].canEditCriterion(_6[i])){_4[_8].setCriterion(_6[i]);_6[i]=null;break}}}
_6.removeEmpty();this.$76u=_1}}
,isc.A.getValuesAsAdvancedCriteria=function(_1){return this.getValuesAsCriteria(true,_1)}
...
return _3.release()}
);isc.evalBoundary;isc.B.push(isc.A.$11i=function(_1){if(!isc.DynamicForm.$11k){isc.DynamicForm.$11l=[" ",isc.DynamicForm.$89,"='",null,"' ",isc.DynamicForm.$9a,"='",isc.DynamicForm.$9g,"' ","ID="]}
...
if(_13){_14.dontValidateNullValues=true;delete _14.typeValidationsOnly;for(var i in _13){var _23=_13[i],_24=i,_25=_23.validators,_19=_12[_24];if(_25!=null){var _19=_12[_24];var _21=this.validateField(_23,_25,_19,_12,_14);if(_21!=null&&_21.errors!=null){this.addValidationError(_10,_24,_21.errors)}}
...
,isc.A.setVisibility=function(_1,_2,_3,_4){this.invokeSuper(isc.DynamicForm,"setVisibility",_1,_2,_3,_4);this.itemsVisibilityChanged();if(this.isVisible()&&this.isDrawn()&&this.autoFocus)this.focus()}
...
,isc.A.bubbleItemHandler=function(_1,_2,_3,_4,_5,_6){var _7=this.getItemById(_1),_8=null;for(;_7!=null;_7=_7.parentItem){if(_7.form!=this)continue;if(_7[_2]!=null&&!isc.isA.Function(_7[_2])){isc.Func.replaceWithMethod(_7,_2,"arg1,arg2,arg3,arg4")}
...
);isc.B._maxIndex=isc.C+217;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.A.$67f="NestedEditorItem";isc.A.$67g="NestedListEditorItem";isc.A.$677="imageFile";isc.A.$678="ViewFileItem";isc.A.$450="id";isc.B.push(isc.A.getEditorType=function(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=_2.getDataSource();var _4=this.defaultFieldType,_5=_1.editorType||_1.formItemType||_1._constructor||_1.type||_4;if(_1.editorType||_1.formItemType||_1._constructor)return _5;if(_5==this.$12a){if(!this.canEditField(_1,_2))_5=this.$12a;else _5=this.$gx}else if(!this.canEditField(_1,_2)){if(_5==this.$12e||_5==this.$52x||_5==this.$677)
...
return[_1,_2,_3,_4]}
,isc.A.getCellHeight=function(_1){if(isc.$cv)arguments.$cw=this;if(this.cellHeight!=null)return this.cellHeight;var _2=this.getHeight(_1);if(!isc.isA.Number(_2))return _2;var _3=this.getIconsHeight();if(_2<_3){_2=_3}
...
return _2}
,isc.A.shouldFixRowHeight=function(){return this.cellHeight!=null}
...
,isc.A.$36c=function(_1){this.$753(_1);if(this.iconIsDisabled(_1))_1.$153=true}
...
return _2}
,isc.A.$753=function(_1,_2){if(_2==null)_2=_1.name;if(_2==null&&_1.$151!=null){this.logWarn("Attempting to use '$151' property as icon name - this property has been deprecated in favor of 'name'");_2=_1.$151}
...
return _2[_1]}
,isc.A.$16g=function(_1){_1=this.getIcon(_1);if(_1==null||_1.imgOnly)return null;var _2=this.$16q(_1.name);return isc.Element.get(_2)}
,isc.A.$16v=function(_1){_1=this.getIcon(_1);if(_1==null)return null;var _2=this.$16n(_1.name);return isc.Element.get(_2)}
...
,isc.A.getIcon=function(_1){if(_1==null)return;var _2;if(this.icons){for(var i=0;i<this.icons.length;i++){if(this.icons[i]==_1||this.icons[i].name==_1)_2=this.icons[i]}}
...
,isc.A.$17a=function(_1){if(!_1)_1=isc.EH.lastEvent;var _2=_1.itemInfo;return(_2&&(_2.overControlTable||this.$169(_1)||(_2.overIcon&&this.getIcon(_2.overIcon)==this.getPickerIcon())))}
...
return this.$17d(_1)}
,isc.A.$17b=function(_1,_2){var _3=_2?null:_1;var _4=this.getValueMap();if(!_4)return _3;if(isc.isA.String(_4))_4=this.getGlobalReference(_4);if(isc.isAn.Array(_4))return _3;var _5;if(isc.isAn.Array(_1)){_5="";for(var i=0;i<_1.length;i++){_5+=isc.getValueForKey(_1[i],_4,_3);if(i!=_1.length-1)_5+=this.multipleValueSeparator}}else{_5=isc.getValueForKey(_1,_4,_3)}
return _5}
...
,isc.A.setValue=function(_1,_2){this.$17g=true;this.$751=null;var _3=(this.maintainSelectionOnTransform&&this.hasFocus&&(this.$17h()!=this.$14l));if(_3)this.rememberSelection();if(this.$17i!=null){isc.Timer.clearTimeout(this.$17i);this.$17i=null}
...
this.$751=_4;if(this.$43d==null)this.$43d={};var _8=this.$43d;var _9;for(var i=0;i<_2.length;i++){_4=_2[i];var _11=_4[_7],_12=_4[_6];if(_8[_11]!==_9){if(_8[_11]!=_12){this.logWarn("Deriving valueMap for '"+_7+"' from dataSource based on displayField '"+_6+"'. This dataSource contains more than one record with "+_7+" set to "+_11+" with differing "+_6+" values."+" Derived valueMap is therefore unpredictable.")}
continue}
_8[_4[_7]]=_4[_6]}
if(this.filterLocally)this.$43e=true;var _13=(this._value==_5);this.updateValueMap(_13)}
,isc.A.getSelectedRecord=function(){if(!this.$751&&this._value!=null&&this.optionDataSource){if(this.pickList&&this.pickList.data)
this.$751=this.pickList.data.find(this.valueField,this._value)}
return this.$751}
...
,isc.A.hasAdvancedCriteria=function(){return this.operator!=null}
,isc.A.getOperator=function(){if(this.operator){var _1=this.operator}else{if(this.valueMap||this.optionDataSource||isc.SimpleType.inheritsFrom(this.type,"enum")){_1="equals"}else{_1="iContains"}}
return _1}
,isc.A.canEditCriterion=function(_1){if(_1.fieldName!=null&&_1.fieldName==this.getCriteriaFieldName()){if(_1.operator!=this.getOperator()){this.logWarn("Attempting to edit AdvancedCriteria in a dynamicForm. Criteria "+"includes a value for field:"+_1.fieldName+". Matches the fieldName for this item, but the specified operator:"+_1.operator+" does not match the operator for this form item:"+this.getOperator()+". Unclear how to combine values for this field, so "+"leaving original criterion in place.");return false}
return true}
return false}
,isc.A.getCriterion=function(){var _1=this.getCriteriaValue();if(_1==null||isc.is.emptyString(_1))return;if(isc.isAn.Array(_1)){if(_1.length==0||_1.contains(isc.emptyString))return}
var _2=this.getOperator();return{fieldName:this.getCriteriaFieldName(),operator:_2,value:_1}}
,isc.A.setCriterion=function(_1){this.setValue(_1.value)}
...
);isc.evalBoundary;isc.B.push(isc.A.clearCompletion=function(){delete this.$17k;delete this.$17o}
...
,isc.A.$121=function(_1,_2){var _3=this.getIcon(_1);if(_3!=null){var _4=(_3.prompt!=null?_3.prompt:this.iconPrompt)
window.status=_4;if(this.$54o(_3)){this.$164(_3,false,true)}
else if(this.$165(_3))this.$164(_3,true)}
return this.$12v(_2,this)}
,isc.A.$123=function(_1,_2){var _3=this.getIcon(_1);if(_3!=null){window.status="";var _4=this.$54o(_3),_5=_3.showFocusedWithItem!=false,_6=this.showIconsOnFocus;if(_4&&(!_6||!_5)){this.$164(_3,false,false)}
if(this.$165(_3))this.$164(_3,false,false)}
return this.$12x(_2,this)}
,isc.A.$113=function(_1){if(_1==this.getErrorIconId())return this.$17y();var _2=this.getIcon(_1);if(_2!=null){if(this.$165(_2))this.$164(_2,true);this.$17z=_2;isc.Hover.setAction(this,this.$170,null,this.$17v());var _3=(_2.prompt!=null?_2.prompt:this.iconPrompt)
window.status=_3;return true}}
,isc.A.$114=function(_1){if(_1==this.getErrorIconId())return this.$171();var _2=this.getIcon(_1);if(_2!=null){window.status="";if(this.$165(_2))this.$164(_2,false);delete this.$17z;isc.Hover.setAction(this,this.$wb,null,this.$17v());return true}}
,isc.A.$116=function(_1){var _2=this.getIcon(_1);if(_2==null)return;if(this.iconIsDisabled(_2))return;if(_2.click!=null){if(!isc.isA.Function(_2.click)){isc.Func.replaceWithMethod(_2,"click","form,item,icon")}
if(_2.click(this.form,this,_2)==false)return false}
if(this.iconClick)this.iconClick(this.form,this,_2)}
,isc.A.$172=function(_1){var _2=this.getIcon(_1);if(_2){var _3=isc.EH.getKey(),_4=isc.EH.getKeyEventCharacter();if(_2.keyPress){if(!isc.isA.Function(_2.keyPress)){isc.Func.replaceWithMethod(_2,"keyPress","keyName, character,form,item,icon")}
...
,isc.A.iconIsDisabled=function(_1){_1=this.getIcon(_1);if(!_1)return;if(this.containerWidget&&this.containerWidget.isDisabled())return true;if(_1.neverDisable)return false;return this.isDisabled()}
,isc.A.$kk=function(){if(this.canFocus!=null)return this.canFocus;return this.hasDataElement()}
,isc.A.focusInItem=function(){var _1=this.isVisible()&&this.$kk()&&!this.isDisabled(),_2=_1?this.getFocusElement():null;if(!_1||!_2){return}
...
,isc.A.focusInIcon=function(_1){_1=this.getIcon(_1);if(_1==null||_1.imgOnly)return;var _2=this.$16g(_1);if(_2!=null)_2.focus()}
,isc.A.blurIcon=function(_1){if(isc.isA.String(_1))_1=this.getIcon(_1);if(_1==null||!this.icons||!this.icons.contains(_1)||_1.imgOnly)return;var _2=this.$16g(_1);if(_2!=null)_2.blur()}
...
,isc.A.addValidatorDefinitions=function(_1){if(!_1||!isc.isAn.Object(_1))return;for(var _2 in _1){if(this.$74u[_2]){isc.logWarn("addValidatorDefinitions: Validator definition already exists "+"for type "+_2+". Replacing.")}}
...
,isc.A.recordClick=function(_1,_2,_3,_4,_5,_6,_7){if(!this.allowMultiSelect)this.hide();if(_2!=null)this.itemClick(_2)}
,isc.A.itemClick=function(_1){var _2=this.formItem,_3=_2.getValueFieldName();if(this.allowMultiSelect){var _4=this.getSelection();var _5=[];for(var i=0;i<_4.length;i++){var _7=_4[i];_5.add(_7[_3])}
...
return _1},setUpPickList:function(_1,_2,_3){var _4=this.pickList;var _5=this.pickListCellHeight;_4.setCellHeight(_5);this.$19n();this.setUpPickListFields();if(!_4.originalEmptyMessage)_4.originalEmptyMessage=_4.emptyMessage;_4.emptyMessage=this.emptyPickListMessage||_4.originalEmptyMessage;this.filterPickList(_1,_2,_3)},$19n:function(){var _1=this.pickList.formItem;if(_1==this)return;var _2=this.pickListProperties||{};isc.addProperties(_2,{formItem:this,baseStyle:(this.pickList.cellHeight>this.pickList.normalCellHeight)?"cell":this.pickListBaseStyle,hiliteColor:this.pickListHiliteColor,hiliteTextColor:this.pickListHiliteTextColor,showModal:this.modalPickList,dateFormatter:this.dateFormatter,dataArrived:function(_3,_4){if(isc.$cv)arguments.$cw=this;this.Super("dataArrived",arguments);if(this.formItem)this.formItem.handleDataArrived(_3,_4,this)}});if(this.multiple&&this.multipleAppearance=="picklist"&&this.allowMultiSelect)
...
if(_8){if(this.pickList.allowMultiSelect)this.pickList.selectRecord(_8);else this.pickList.selection.selectSingle(_8);_5=_9.indexOf(_8)}else{_4=false}}
...
,isc.A.$16m=function(){return 0}
,isc.A.$121=function(_1,_2){var _3=this.getIcon(_1);if(_3==this.getPickerIcon()){_2.blur();this.focusInItem();return}
...
,isc.A.$114=function(_1,_2,_3,_4,_5){if(this.getIcon(_1)==this.getPickerIcon()&&this.$17a())return;return this.invokeSuper("SelectItem","$114",_1,_2,_3,_4,_5)}
...
return _3}
,isc.A.handleEditorExit=function(){isc.logWarn("handleEditorExit: $19g="+this.$19g);if(this.$19g)return;return this.Super("handleEditorExit",arguments)}
...
,isc.A.$19h=function(){if(this.fireChangeOnSelect==false)this.updateValue();if(this.pickListHidden)this.pickListHidden()}
...
return null}
,isc.A.getSelectedRecords=function(){var _1=this.$19w;this.selectItemFromValue(_1);var _2=this.pickList.getSelection();if(_2.length>0)return _2;else return null}
...
);isc.B._maxIndex=isc.C+53;isc.ClassFactory.mixInInterface("SelectItem","PickList");isc.SelectItem.registerStringMethods({dataArrived:"startRow,endRow,data",getPickListFilterCriteria:""})}
...
_1.add(_12)}else if(_11=="M"){var _13;if(this.monthSelectorProperties!=null){_13=isc.addProperties({},this.monthSelectorDefaults,_2.MONTH_SELECTOR,this.monthSelectorProperties)}else{_13=isc.addProperties({},this.monthSelectorDefaults,_2.MONTH_SELECTOR)}
_1.add(_13)}else if(_11=="Y"){var _14;if(this.yearSelectorProperties!=null){_14=isc.addProperties({},this.yearSelectorDefaults,_2.YEAR_SELECTOR,this.yearSelectorProperties)}else{_14=isc.addProperties({},this.yearSelectorDefaults,_2.YEAR_SELECTOR)}
_1.add(_14)}}}
...
,isc.A.showPicker=function(){if(!this.picker){if(this.useSharedPicker)this.picker=isc.DateChooser.getSharedDateChooser();else{this.picker=isc[this.pickerConstructor].create(isc.addProperties({},this.pickerDefaults,this.pickerProperties,{border:"none",_generated:true,autoHide:true,showCancelButton:true}))}}
...
,isc.A.getPickerRect=function(){var _1=this.getPageLeft(),_2=this.getPageTop(),_3=isc.DateItem.chooserWidth+3,_4=isc.DateItem.chooserHeight+3;_1+=Math.round((this.getVisibleWidth()-(this.getPickerIconWidth()/2))-
...
,isc.A.$10y=function(_1){_1=this.mapDisplayToValue(_1);if(_1==this._value)return true;var _2=this.handleChange(_1,this._value);if(this.$17n!=_1){this.logWarn("Upload Items do not support programmatically modifying the value entered "+"by the user. Ignoring attempt to update from change handler")}
...
,isc.A.selectDefaultItem=function(){if(this.pickList==null||this.pickList.destroyed)return;var _1=this.pickList.selection;if(this.pickList.selection.anySelected()){if(this.optionDataSource){var _2=this.getSelectedRecord();if(_2){this.pickList.clearLastHilite();this.delayCall("selectItemFromValue",[_2[this.valueField]])}}
return}
...
,isc.A.setValue=function(_1){if(_1==null||isc.isA.emptyString(_1)){this.canvas.setValue(this.getFieldName(),_1);return this.Super("setValue",arguments)}else{this.logWarn("Cannot programmatically set the value of an upload field due to security restraints");return}}
...
,isc.A.$14v=function(){this.Super("$14v",arguments);if(this.showActionIcon){if(this.icons==null)this.icons=[];var _1=this.actionIconPosition;this.icons.addAt({name:"action",src:this.actionIconSrc,showOver:false,width:this.actionIconWidth,height:this.actionIconHeight,click:this.getID()+".showActionMenu();return false;"},_1);this.$36c(this.icons[_1])}}
...
if(this.form.saveProperties){this.form.saveProperties(this.dataPathProps,this.form.currentComponent)}}
);isc.B._maxIndex=isc.C+9;if(isc.ListGrid){isc.defineClass("RelativeDateItem","CanvasItem");isc.A=isc.RelativeDateItem;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.mapRelativeDateShortcut=function(_1){switch(_1){case"$now":return"+0MS";case"$today":case"$startOfToday":return"-0D";case"$endOfToday":return"+0D";case"$yesterday":case"$startOfYesterday":return"-1D";case"$endOfYesterday":return"-1ms[-0D]";case"$tomorrow":case"$startOfTomorrow":return"+1ms[D]";case"$endOfTomorrow":return"+1D";case"$startOfWeek":return"-0W";case"$endOfWeek":return"+0W";case"$startOfMonth":return"-0M";case"$endOfMonth":return"+0M";case"$startOfYear":return"-0Y";case"$endOfYear":return"+0Y"}
return _1}
,isc.A.getAbsoluteDate=function(_1,_2){var _3=isc.RelativeDateItem,_4=_1,_5=new Date();_4=_3.mapRelativeDateShortcut(_1);var _6=_3.getRelativeDateParts(_4);var _7;_2=_2||new Date();_5.setTime(_2.getTime());if(_6.qualifier){_6.qualifier=_6.qualifier.toUpperCase();var _8=_3.getRelativeDateParts(_6.qualifier);var _9=["S","MN","H","D","W","M","Q","Y"];if(_9.contains(_8.period)){_5=_3.dateAdd(_5,_8.period,_8.countValue,(_8.direction=="+"?1:-1))}else{isc.logWarn("Invalid date-offset qualifier provided: "+_8.period+".  Valid "+"options are: S, MN, H, D, W, M, Q and Y.")}}
_7=_3.dateAdd(_5,_6.period,_6.countValue,(_6.direction=="+"?1:-1));return _7}
,isc.A.getRelativeDateParts=function(_1){var _2=_1,_3=_2.substring(0,1),_4=_2.indexOf("["),_5=(_4>0?_2.substring(_4):null),_6=(_5!=null?_2.substring(1,_4):_2.substring(1)),_7=parseInt(_6),_8=_6.replace(_7,"");return{direction:(_3=="+"||_3=="-"?_3:"+"),qualifier:_5?_5.replace("[","").replace("]","").replace(",",""):null,countValue:isc.isA.Number(_7)?_7:0,period:_8?_8:_3}}
,isc.A.isRelativeDate=function(_1){if(isc.isA.Date(_1))return false;if(isc.isAn.Object(_1)&&_1._constructor=="RelativeDate")return true;return false}
,isc.A.getPeriodName=function(_1){var _2=_1.toLowerCase();switch(_2){case"ms":return"Millisecond";case"s":return"Second";case"mn":return"Minute";case"h":return"Hour";case"d":return"Day";case"w":return"Week";case"m":return"Month";case"q":return"Quarter";case"y":return"Year";case"dc":return"Decade";case"c":return"Century"}}
,isc.A.dateAdd=function(_1,_2,_3,_4){var _5=isc.RelativeDateItem,_6=_1;switch(_2){case"MS":case"ms":_6.setUTCMilliseconds(_1.getUTCMilliseconds()+(_3*_4));break;case"S":case"s":_6.setUTCSeconds(_1.getUTCSeconds()+(_3*_4));if(_2=="S"){_6=_5.getEndOf(_6,"S");break}
break;case"MN":case"mn":_6.setUTCMinutes(_1.getUTCMinutes()+(_3*_4));if(_2=="MN"){_6=_5.getEndOf(_6,"MN");break}
break;case"H":case"h":_6.setUTCHours(_1.getUTCHours()+(_3*_4));if(_2=="H"){_6=_5.getEndOf(_6,"H");break}
break;case"D":case"d":_6.setUTCDate(_1.getUTCDate()+(_3*_4));if(_2=="D"){switch(_4){case 1:_6=_5.getEndOf(_6,"D");break;case-1:_6=_5.getStartOf(_6,"D");break}}
break;case"W":case"w":_6.setUTCDate(_1.getUTCDate()+((_3*7)*_4));if(_2=="W"){_6=_5.getEndOf(_6,"W")}
break;case"M":case"m":_6.setUTCMonth(_1.getUTCMonth()+(_3*_4));if(_2=="M"){_6=_5.getEndOf(_6,"M")}
break;case"Q":case"q":_6.setUTCMonth(_1.getUTCMonth()+((_3*3)*_4));if(_2=="Q"){_6=_5.getEndOf(_6,"Q")}
break;case"Y":case"y":_6.setUTCFullYear(_1.getUTCFullYear()+(_3*_4));if(_2=="Y"){_6=_5.getEndOf(_6,"Y")}
break;case"DC":case"dc":_6.setUTCFullYear(_1.getUTCFullYear()+((_3*10)*_4));if(_2=="DC"){_6=_5.getEndOf(_6,"DC")}
break;case"C":case"c":_6.setUTCFullYear(_1.getUTCFullYear()+((_3*100)*_4));if(_2=="C"){_6=_5.getEndOf(_6,"C")}
break}
return _6}
,isc.A.getStartOf=function(_1,_2){var _3=_1;switch(_2){case"s":case"S":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),_3.getUTCHours(),_3.getUTCMinutes(),_3.getUTCSeconds(),0);case"mn":case"MN":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),_3.getUTCHours(),_3.getUTCMinutes(),0,0);case"h":case"H":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),_3.getUTCHours(),0,0,0);case"d":case"D":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),0,0,0,0);case"w":case"W":_3.setDate(_1.getUTCDate()-_1.getUTCDay());return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),0,0,0,0);case"m":case"M":return new Date(_1.getUTCFullYear(),_1.getUTCMonth(),1,0,0,0,0);case"q":case"Q":var _4=Math.floor((_1.getUTCMonth+1)/3)*3;return new Date(_1.getUTCFullYear(),_4-1,1,0,0,0,0);case"y":case"Y":return new Date(_1.getUTCFullYear(),0,1,0,0,0,0);case"dc":case"DC":var _5=Math.floor(_1.getUTCFullYear()/10)*10;return new Date(_5,0,1,0,0,0,0);case"c":case"C":var _6=Math.floor(_1.getUTCFullYear()/100)*100;return new Date(_6,0,1,0,0,0,0)}
return _3}
,isc.A.getEndOf=function(_1,_2){var _3=_1;switch(_2){case"s":case"S":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),_3.getUTCHours(),_3.getUTCMinutes(),_3.getUTCSeconds(),999);case"mn":case"MN":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),_3.getUTCHours(),_3.getUTCMinutes(),59,999);case"h":case"H":return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),_3.getUTCHours(),59,59,999);case"d":case"D":return new Date(_1.getUTCFullYear(),_1.getUTCMonth(),_1.getUTCDate(),23,59,59,999);case"w":case"W":_3.setUTCDate(_1.getUTCDate()+(6-_1.getUTCDay()));return new Date(_3.getUTCFullYear(),_3.getUTCMonth(),_3.getUTCDate(),23,59,59,999);case"m":case"M":_3=new Date(_1.getUTCFullYear(),_1.getUTCMonth()+1,1,23,59,59,999);_3.setUTCDate(_3.getUTCDate()-1);return _3;case"q":case"Q":var _4=Math.floor((_1.getUTCMonth()+4)/3)*3;_3=new Date(_1.getUTCFullYear(),_4,1,23,59,59,999);_3.setUTCDate(_3.getUTCDate()-1);return _3;case"y":case"Y":return new Date(_1.getUTCFullYear(),11,31,23,59,59,999);case"dc":case"DC":var _5=((_1.getUTCFullYear()/10)*10)+9;return new Date(_5,11,1,23,59,59,999);case"c":case"C":var _6=(Math.floor(_1.getUTCFullYear()/100)*100)+99;return new Date(_6,11,1,23,59,59,999)}
return _3}
);isc.B._maxIndex=isc.C+8;isc.A=isc.RelativeDateItem.getPrototype();isc.A.height=20;isc.A.cellHeight=20;isc.A.canFocus=true;isc.A.timeUnitOptions=["day","week","month"];isc.A.todayTitle="Today";isc.A.millisecondsAgoTitle="N milliseconds ago";isc.A.secondsAgoTitle="N seconds ago";isc.A.minutesAgoTitle="N minutes ago";isc.A.hoursAgoTitle="N hours ago";isc.A.daysAgoTitle="N days ago";isc.A.weeksAgoTitle="N weeks ago";isc.A.monthsAgoTitle="N months ago";isc.A.yearsAgoTitle="N years ago";isc.A.millisecondsFromNowTitle="N milliseconds from now";isc.A.secondsFromNowTitle="N seconds from now";isc.A.minutesFromNowTitle="N minutes from now";isc.A.hoursFromNowTitle="N hours from now";isc.A.daysFromNowTitle="N days from now";isc.A.weeksFromNowTitle="N weeks from now";isc.A.monthsFromNowTitle="N months from now";isc.A.yearsFromNowTitle="N years from now";isc.A.defaultValue="$today";isc.A.operator="greaterThan";isc.A.presetOptions={"$today":"Today","$yesterday":"Yesterday","$tomorrow":"Tomorrow","-1w":"Current day of last week","+1w":"Current day of next week","-1m":"Current day of last month","+1m":"Current day of next month"};isc.A.valueFieldDefaults={type:"ComboBoxItem",name:"valueField",showTitle:false,shouldSaveValue:false};isc.A.defaultQuantity=1;isc.A.quantityFieldDefaults={type:"SpinnerItem",name:"quantityField",width:80,min:0,step:1,showTitle:false,shouldSaveValue:false,iconVAlign:"top"};isc.A.showChooserIcon=true;isc.A.pickerIconDefaults={name:"chooserIcon",showOver:false,showFocused:false,showFocusedWithItem:false,neverDisable:true,src:"[SKIN]/DynamicForm/DatePicker_icon.gif"};isc.A.pickerIconPrompt="Show Date Chooser";isc.A.pickerConstructor="DateChooser";isc.A.showCalculatedDateField=true;isc.A.calculatedDateFieldDefaults={type:"BlurbItem",name:"calculatedDateField",border:"1px solid black;",width:"*",startRow:false,showTitle:false,shouldSaveValue:false};isc.A.startDate=isc.DateItem.DEFAULT_START_DATE;isc.A.endDate=isc.DateItem.DEFAULT_END_DATE;isc.A.centuryThreshold=isc.DateItem.DEFAULT_CENTURY_THRESHOLD;isc.A.shouldSaveValue=true;isc.A.editorConstructor="DynamicForm";isc.A.editorDefaults={numCols:3,width:290,colWidths:[130,80,80],margin:0,padding:0,itemChanged:function(_1,_2){this.creator.updateValue(this.getValuesAsCriteria())}};isc.A.useSharedPicker=false;isc.A.pickerDefaults={width:isc.DateItem.chooserWidth,height:isc.DateItem.chooserHeight,border:"1px solid black;",showCancelButton:true,autoHide:true};isc.A=isc.RelativeDateItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function(){this.$67h();this.Super("init",arguments)}
,isc.A.isEditable=function(){return true}
,isc.A.$67h=function(){var _1;var _2={};this.addAutoChild("editor",_2);this.canvas=this.editor;var _3=this,_4=[];_4[0]=isc.addProperties({},this.valueFieldDefaults,this.valueFieldProperties,{valueMap:this.getValueFieldOptions(),changed:function(_5,_6,_7){_3.valueFieldChanged(_7)}});_4[1]=isc.addProperties({},this.quantityFieldDefaults,this.quantityFieldProperties,{defaultValue:this.defaultQuantity,changed:function(_5,_6,_7){_3.quantityFieldChanged(_7)}});this.baseDate=this.baseDate||new Date();if(this.showCalculatedDateField){_4[2]=isc.addProperties({},this.calculatedDateFieldDefaults,this.calculatedDateFieldProperties,{cellStyle:this.getHintStyle()})}
...
this.calculatedDateField=this.canvas.getField("calculatedDateField");if(this.showChooserIcon){this.quantityField.icons.add(isc.addProperties({prompt:this.pickerIconPrompt},this.pickerIconDefaults,this.pickerIconProperties,{click:function(){_3.showPicker()}}));this.pickerIcon=this.quantityField.icons.find("name","chooserIcon")}
this.setValue(this.defaultValue)}
,isc.A.valueFieldChanged=function(_1){this.fieldChanged()}
,isc.A.quantityFieldChanged=function(_1){this.fieldChanged()}
,isc.A.fieldChanged=function(){if(!this.valueField||!this.quantityField)return;var _1=this.valueField.getValue(),_2=this.quantityField.getValue();var _3=(_1&&isc.isA.String(_1)&&_1.indexOf("_")!=-1);if(!_3){this.quantityField.hide();if(this.showChooserIcon&&this.pickerIcon!=null){if(!this.valueField.icons)this.valueField.icons=[];if(this.valueField.icons.length==0)
this.valueField.icons.add(this.pickerIcon)}}else{if(this.showChooserIcon&&this.pickerIcon!=null){if(this.valueField.icons&&this.valueField.icons.length>0)
...
,isc.A.getValueFieldOptions=function(){var _1=isc.clone(this.presetOptions);for(var i=0;i<this.timeUnitOptions.length;i++){var _3=this.timeUnitOptions[i];_1[_3+"_ago"]=this[_3+"sAgoTitle"];_1[_3+"_fromNow"]=this[_3+"sFromNowTitle"]}
return _1}
,isc.A.setValue=function(_1){if(_1==null){this.valueFieldChanged(_1);return}
if(isc.isA.Date(_1)||this.valueField.valueMap[_1]){this.valueField.setValue(isc.isA.Date(_1)?this.formatDate(_1):_1);this.valueFieldChanged(_1);return}
if(this.timeUnitOptions.contains(_1)){_1+="_fromNow";this.valueField.setValue(_1);this.valueFieldChanged(_1);return}
...
,isc.A.getValue=function(){if(!this.valueField||!this.quantityField)return;var _1=this.getRelativeDate();if(_1)
...
,isc.A.getRelativeDate=function(){var _1=this.valueField.getValue(),_2=this.quantityField.getValue();if(!_1||!isc.isA.String(_1))return null;var _3=_1.substring(0,1);if(_3=="+"||_3=="-"||_3=="$"){return this.getRelativeDateObject(_1)}
...
return null}
,isc.A.getRelativeDateObject=function(_1){return{_constructor:"RelativeDate",value:_1}}
,isc.A.updateValue=function(_1){this.$10y(_1)}
,isc.A.getCriteriaValue=function(){return this.getRelativeDate()}
,isc.A.getCriterion=function(_1){var _2=this.valueField.getValue();if(_1==null&&isc.RelativeDateItem.isRelativeDate(_2))_1=false;var _3=(_1?this.getValue():this.getRelativeDate());return{operator:this.operator,value:_3}}
,isc.A.getCellHeight=function(){var _1=this.Super("getCellHeight",arguments);if(isc.Browser.isIE&&this.useTextField&&isc.isA.Number(_1))_1+=2;return _1}
,isc.A.getPickerIcon=function(_1,_2,_3,_4){var _5=this.invokeSuper(isc.DateItem,"getPickerIcon",_1,_2,_3,_4);if(_5.prompt==null)_5.prompt=this.pickerIconPrompt;return _5}
,isc.A.showPicker=function(){if(!this.picker){if(this.useSharedPicker)this.picker=isc.DateChooser.getSharedDateChooser();else{this.picker=isc[this.pickerConstructor].create(isc.addProperties({},this.pickerDefaults,this.pickerProperties,{border:"none",_generated:true,autoHide:true,showCancelButton:true}))}}
...
_1.startYear=this.getStartDate().getFullYear();_1.endYear=this.getEndDate().getFullYear();return this.Super("showPicker",arguments)}
,isc.A.getPickerRect=function(){var _1=this.getPageLeft(),_2=this.getPageTop(),_3=isc.DateItem.chooserWidth+3,_4=isc.DateItem.chooserHeight+3,_5=this.canvas,_6;if(_5.getItem(0).icons&&_5.getItem(0).icons.length>0){_6=_5.getItem(0)}else{_6=_5.getItem(1)}
_1+=_6.getLeft();_1+=Math.round((_6.getVisibleWidth()-(this.getPickerIconWidth()/2))-
(_3/ 2));_2+=Math.round((this.getPickerIconHeight()/2)-(_4/ 2));return[_1,_2]}
,isc.A.pickerDataChanged=function(_1){var _2=_1.getData();var _3=_2.getFullYear(),_4=_2.getMonth(),_5=_2.getDate();this.$20l=true;this.valueField.setValue(this.formatDate(_2));this.$20l=false;this.updateValue();this.fieldChanged();if(!this.hasFocus)this.focusInItem()}
,isc.A.getStartDate=function(){var _1=this.parseDate(this.startDate);if(!isc.isA.Date(_1)){this.logWarn("startDate was not in valid date format - using default start date");_1=isc.DateItem.DEFAULT_START_DATE}
return _1}
,isc.A.getEndDate=function(){var _1=this.parseDate(this.endDate);if(!isc.isA.Date(_1)){this.logWarn("endDate was not in valid date format - using default end date");_1=isc.DateItem.DEFAULT_END_DATE}
return _1}
...
if(isc.ListGrid){isc.defineClass("DateRangeItem","CanvasItem");isc.A=isc.DateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.shouldSaveValue=true;isc.A.fromTitle="From";isc.A.toTitle="To";isc.A.allowRelativeDates=false;isc.A.dateRangeFormDefaults={_constructor:"DynamicForm",numCols:2,margin:0,padding:0,itemChanged:function(_1,_2){this.creator.updateValue(this.getValuesAsCriteria())}};isc.B.push(isc.A.setFromDate=function(_1){this.fromDate=_1;if(this.fromField)this.fromField.setValue(this.fromDate)}
,isc.A.setToDate=function(_1){this.toDate=_1;if(this.toField)this.toField.setValue(this.toDate)}
,isc.A.hasAdvancedCriteria=function(){return true}
,isc.A.getCriterion=function(_1){_1=_1||!this.allowRelativeDates;var _2=_1?this.fromField.getValue():this.fromField.getRelativeDate()||this.fromField.getValue(),_3=_2!=null,_4=_1?this.toField.getValue():this.toField.getRelativeDate()||this.toField.getValue(),_5=_4!=null,_6=null;if(_3&&_5){_6={_constructor:"AdvancedCriteria",operator:"and",criteria:[{fieldName:this.fieldName||this.name,operator:"greaterThan",value:_2},{fieldName:this.fieldName||this.name,operator:"lessThan",value:_4}]}}else if(_3||_5){_6={fieldName:this.fieldName||this.name,operator:(_3?"greaterThan":"lessThan"),value:(_3?_2:_4)}}
return _6}
,isc.A.canEditCriterion=function(_1){if(_1==null)return false;var _2=this.getCriteriaFieldName();if(_1.operator=="and"){var _3=_1.criteria;if(_3.length==0||_3.length>2){return false}
for(var i=0;i<_3.length;i++){var _5=_3[i];if(_5.fieldName!=_2)return false;if(_5.operator!="greaterThan"&&_5.operator!="lessThan")
{this.logWarn("DynamicForm editing Advanced criteria. Includes criterion for "+"field "+_2+". A dateRange editor is showing for this field but "+"the existing criteria has operator:"+_5.operator+". DateRange "+"items can only edit criteria greaterThan or lessThan so leaving this "+"unaltered.");return false}}
return true}else if(_1.fieldName==_2){if(_1.operator!="greaterThan"&&_1.operator!="lessThan"){this.logWarn("DynamicForm editing Advanced criteria. Includes criterion for "+"field "+_2+". A dateRange editor is showing for this field but "+"the existing criteria has operator:"+_1.operator+". DateRange "+"items can only edit criteria greaterThan or lessThan so leaving this "+"unaltered.");return false}
return true}
return false}
,isc.A.setCriterion=function(_1){var _2,_3;if(_1.operator=="and"){_2=_1.criteria.find("operator","greaterThan");_3=_1.criteria.find("operator","lessThan")}else{if(_1.operator=="greaterThan")_2=_1;else if(_1.operator=="lessThan")_3=_1}
if(_2!=null){this.fromField.setValue(_2.value)}
if(_3!=null){this.toField.setValue(_3.value)}}
);isc.B._maxIndex=isc.C+6;isc.A=isc.DateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function(){this.$67h();this.Super("init",arguments)}
,isc.A.isEditable=function(){return true}
,isc.A.$67h=function(){var _1;var _2={};if(this.form.dataSource){_1=isc.DataSource.getDataSource(this.form.dataSource);var _3=_1.getField(this.name);if(_3){_2.dataSource=_1.getFieldDataSource(_3)}}
if(this.form&&this.form.showComplexFieldsRecursively){_2.showComplexFields=true;_2.showComplexFieldsRecursively=true}else{_2.showComplexFields=false}
_2.height=22;this.addAutoChild("dateRangeForm",_2);this.canvas=this.dateRangeForm;this.baseDate=this.baseDate||new Date();var _4=this,_5=this.allowRelativeDates?"RelativeDateItem":"DateItem",_6=[];_6[0]=isc.addProperties({},this.fromFieldDefaults,this.fromFieldProperties,{name:"fromField",_constructor:_5,baseDate:this.baseDate,displayformat:this.dateDisplayFormat,inputFormat:this.dateInputFormat,title:this.fromTitle,titleOrientation:this.form.titleOrientation,defaultValue:this.fromValue,useTextField:(_5=="DateItem"?true:null)});_6[1]=isc.addProperties({},this.toFieldDefaults,this.toFieldProperties,{name:"toField",_constructor:_5,baseDate:this.baseDate,displayformat:this.dateDisplayFormat,inputFormat:this.dateInputFormat,title:this.toTitle,titleOrientation:this.form.titleOrientation,defaultValue:this.toValue,useTextField:(_5=="DateItem"?true:null)});this.canvas.setFields(_6);this.toField=this.canvas.getField("toField");this.fromField=this.canvas.getField("fromField");if(this.defaultValue){this.setValue(this.defaultValue)}else{if(this.fromDate)this.setFromDate(this.fromDate);if(this.toDate)this.setToDate(this.toDate)}}
,isc.A.fieldChanged=function(){}
,isc.A.setValue=function(_1){if(_1==null)return;if(_1.start!=null)this.setFromDate(_1.start);if(_1.end!=null)this.setToDate(_1.end)}
,isc.A.getValue=function(){if(!this.fromField||!this.toField)return;var _1=this.allowRelativeDates,_2=_1&&this.fromField.getRelativeDate()?this.fromField.getRelativeDate():this.fromField.getValue(),_3=_1&&this.toField.getRelativeDate()?this.toField.getRelativeDate():this.toField.getValue(),_4={};if(_2==null&&_3==null)return null;if(_2!=null)_4.start=_2;if(_3!=null)_4.end=_3;return _4}
,isc.A.updateValue=function(_1){this.$10y(_1)}
);isc.B._maxIndex=isc.C+7;if(isc.Window){isc.defineClass("DateRangeDialog","Window");isc.A=isc.DateRangeDialog;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.askForRange=function(_1,_2,_3,_4){var _5=isc.DateRangeDialog.create({allowRelativeDates:_1!=null?_1:true,rangeItemProperties:_2,callback:_4},_3);_5.show()}
);isc.B._maxIndex=isc.C+1;isc.A=isc.DateRangeDialog.getPrototype();isc.A.isModal=true;isc.A.showModalMask=true;isc.A.dismissOnEscape=true;isc.A.autoCenter=true;isc.A.width=400;isc.A.height=160;isc.A.vertical="true";isc.A.showMinimizeButton=false;isc.A.headerIconProperties={src:"[SKIN]/DynamicForm/DatePicker_icon.gif"};isc.A.headerTitle="Select Date Range";isc.A.mainLayoutDefaults={_constructor:"VLayout",width:"100%",height:"100%",layoutMargin:5};isc.A.rangeFormDefaults={_constructor:"DynamicForm",numCols:1,width:"100%",height:"100%",autoParent:"mainLayout"};isc.A.rangeItemDefaults={_constructor:"DateRangeItem",allowRelativeDates:true,showTitle:false};isc.A.buttonLayoutDefaults={_constructor:"HLayout",width:"100%",height:22,align:"right",membersMargin:5,autoParent:"mainLayout"};isc.A.okButtonDefaults={_constructor:"IButton",height:22,title:"OK",autoParent:"buttonLayout",click:function(){this.creator.accept()}};isc.A.cancelButtonDefaults={_constructor:"IButton",height:22,title:"Cancel",autoParent:"buttonLayout",click:function(){this.creator.cancel()}};isc.A.buttonAutoChildren=["buttonLayout","okButton","cancelButton"];isc.A.destroyOnClose=true;isc.A=isc.DateRangeDialog.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function(){this.title=this.headerTitle;this.Super("initWidget",arguments);this.addAutoChild("mainLayout");this.addAutoChild("rangeForm",{items:[isc.addProperties({},this.rangeItemDefaults,this.rangeItemProperties,{name:"rangeItem",fromDate:this.fromDate,toDate:this.toDate})]});this.rangeItem=this.rangeForm.getField("rangeItem");this.rangeItem.canvas.numCols=1;this.addAutoChildren(this.buttonAutoChildren);this.addItem(this.mainLayout)}
,isc.A.accept=function(){this.finished(this.rangeItem.getValue())}
,isc.A.cancel=function(){this.finished(null)}
,isc.A.finished=function(_1){if(this.callback)this.fireCallback(this.callback,"value",[_1]);this.hide();if(this.destroyOnClose)this.markForDestroy()}
);isc.B._maxIndex=isc.C+4;isc.defineClass("MiniDateRangeItem","StaticTextItem");isc.A=isc.MiniDateRangeItem.getPrototype();isc.A.clipValue=true;isc.A.wrap=false;isc.A.valign="center";isc.A.iconVAlign="top";isc.A.shouldSaveValue=true;isc.A.rangeDialogDefaults={_constructor:"DateRangeDialog",autoDraw:false,destroyOnClose:false};isc.A.pickerIconPrompt="Show Date Chooser";isc.A.pickerIconDefaults={name:"showDateRange",src:"[SKIN]/DynamicForm/DatePicker_icon.gif",click:function(_1,_2,_3){_2.showRangeDialog()}};isc.A.allowRelativeDates=true;isc.A=isc.MiniDateRangeItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function(){this.addAutoChild("rangeDialog",{fromDate:this.fromDate,toDate:this.toDate,callback:this.getID()+".rangeDialogCallback(value)"});this.icons=[isc.addProperties({prompt:this.pickerIconPrompt},this.pickerIconDefaults,this.pickerIconProperties)];this.rangeItem=this.rangeDialog.rangeItem;this.rangeItem.fieldName=this.name}
,isc.A.showRangeDialog=function(){this.rangeDialog.rangeItem.setFromDate(this.fromDate);this.rangeDialog.rangeItem.setToDate(this.toDate);this.rangeDialog.show()}
,isc.A.rangeDialogCallback=function(_1){if(_1!=null){this.setValue(_1)}}
,isc.A.hasAdvancedCriteria=function(){return true}
,isc.A.getCriterion=function(){var _1=this.rangeItem?this.rangeItem.getCriterion():null;return _1}
,isc.A.setCriterion=function(_1){if(this.rangeItem)this.rangeItem.setCriterion(_1)}
,isc.A.canEditCriterion=function(_1){return this.rangeItem?this.rangeItem.canEditCriterion(_1):false}
,isc.A.setValue=function(_1){if(_1==null)return;if(isc.DataSource.isAdvancedCriteria(_1)){var _2={};_2.start=_1.criteria[0].value;_2.end=_1.criteria[1].value;_1=_2}
this.fromDate=_1.start;this.toDate=_1.end;var _3=this.mapValueToDisplay(_1);this.setElementValue(_3,_1);this.Super("setValue",[_1])}
,isc.A.mapValueToDisplay=function(_1){if(_1==null)return;var _2=isc.RelativeDateItem,_3=(_2.isRelativeDate(this.fromDate)?_2.getAbsoluteDate(this.fromDate.value):this.fromDate),_4=(_2.isRelativeDate(this.toDate)?_2.getAbsoluteDate(this.toDate.value):this.toDate);var _5;if(_3||_4){if(_3)_5=this.formatDate(_3);if(_4){if(_5)_5+=" - "+this.formatDate(_4);else _5=this.formatDate(_4)}}
this.prompt=_5||"";return this.prompt}
,isc.A.getValue=function(){if(!this.rangeItem)return;return this.rangeItem.getValue()}
,isc.A.updateValue=function(_1){this.$10y(_1)}
,isc.A.formatDate=function(_1){return isc.isA.Date(_1)?_1.toShortDate(this.displayFormat,this.useCustomTimezone):_1}
,isc.A.getCriteriaValue=function(){return this.getCriterion()}
