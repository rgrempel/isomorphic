...
);isc.B._maxIndex=isc.C+17;isc.ClassFactory.writePassthroughFunctions(isc.MultiView,"currentDBC",["fetchData","filterData","fetchRelatedData","removeSelectedData","anySelected","getSelection","getSelectedRecord","selectRecord","selectRecords","selectAllRecords","deselectRecord","deselectRecords","deselectAllRecords"]);isc.MultiView.registerStringMethods({recordClick:"record,view"});isc.ClassFactory.defineClass("ColorPicker",isc.Window);isc.A=isc.ColorPicker;isc.A.MORE_BUTTON_TITLE="More >>";isc.A.LESS_BUTTON_TITLE="<< Less";isc.A=isc.ColorPicker;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getSharedColorPicker=function isc_c_ColorPicker_getSharedColorPicker(_1,_2){if(!isc.isA.ColorPicker(this.$56b)){this.$56b=isc.ColorPicker.create(_1)}
