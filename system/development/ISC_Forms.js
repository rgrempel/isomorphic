...
);isc.B._maxIndex=isc.C+194;isc.A=isc.DynamicForm;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.defaultFieldType="text";isc.A.$12a="link";isc.A.$gx="text";isc.A.$12b="select";isc.A.$12c="checkbox";isc.A.$12d="staticText";isc.A.$g2="boolean";isc.A.$12e="binary";isc.A.$12f="blob";isc.A.$52w="multifile";isc.A.$12g="multiupload";isc.A.$9i="upload";isc.A.$52x="file";isc.A.$51x="base64Binary";isc.A.$12h="enum";isc.A.$12i="CycleItem";isc.A.$12j="selectOther";isc.A.$12k="relation";isc.B.push(isc.A.getEditorType=function(_1,_2){if(_1._constructor==isc.FormItem.Class)_1._constructor=null;var _3=this.defaultFieldType,_4=_1.editorType||_1.formItemType||_1._constructor||_1.type||_3;if(_1.editorType||_1.formItemType||_1._constructor)return _4;if(_4==this.$12a){if(!this.canEditField(_1,_2))_4=this.$12a;else _4=this.$gx}else if(!this.canEditField(_1,_2)){_4=this.$12d}else if(_4==this.$g2){var _5=_1.valueMap;if(!isc.isAn.Array(_5)&&isc.isAn.Object(_5))_4=this.$12b;else _4=this.$12c}else if(_4==this.$12e||_4==this.$12f||_4==this.$52x){if(_1.dataSource)_4=this.$52w
...
if(this.hintInField)_2=false;var _6=this.$15r(_1,_2,_3);if(_5!=null){_5.append(_6);if(_4)return _5.getArray();return _5.release()}else{return(_4?_6:_6.join(isc.emptyString))}}
...
_1=this.invokeSuper(isc.TextItem,"setValue",_1,_2,_3,_4);if(this.showHint&&this.hintInField&&this.getHint()){if(_1===_5||_1==null||isc.is.emptyString(_1)){this.$66t()}}
return _1}
,isc.A.getCriteriaFieldName=function(){if(this.displayField)return this.displayField;return this.getFieldName()}
,isc.A.$12v=function(_1,_2){var _3=this.Super("$12v",arguments);if(!this.showHint||!this.hintInField||!this.getHint())return;this.$66s();return _3}
,isc.A.$12x=function(_1,_2){var _3=this.Super("$12x",arguments);if(!this.showHint||!this.hintInField||!this.getHint())return _3;var _4;var _5=this.getElementValue();if(this.hintInField&&(_5===_4||_5==null||isc.is.emptyString(_5)))
{this.$66t()}
return _3}
...
,isc.A.$66s=function(){if(this.$66u){this.setElementValue(isc.emptyString);this.$66u=false}}
...
);isc.B._maxIndex=isc.C+21;isc.ComboBoxItem.registerStringMethods({dataArrived:"startRow,endRow,data"});isc.ClassFactory.defineClass("FileItem","CanvasItem");isc.A=isc.FileItem.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.shouldSaveValue=true;isc.B.push(isc.A.$18y=function(){this.canvas=isc.DynamicForm.create({autoDraw:false,$nu:false,redrawOnResize:false,canSubmit:true,action:this.action,items:[{targetItem:this,type:"upload",name:this.getFieldName(),showTitle:false,saveValue:function(_1,_2,_3,_4){this.Super("saveValue",arguments);this.targetItem.saveValue(_1,_2,_3,_4)}},{name:"_transaction",type:"HiddenItem"}]});this.containerWidget.addChild(this.canvas)}
