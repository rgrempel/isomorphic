...
,isc.A.refreshSelectedView=function(){if(this.dayViewSelected()){this.dayView.refreshEvents();if(this.monthView)this.monthView.refreshEvents()}else if(this.weekViewSelected()){this.weekView.refreshEvents();if(this.monthView)this.monthView.refreshEvents()}else if(this.monthViewSelected()){this.monthView.refreshEvents()}else if(this.eventsByTypeViewSelected()){this.eventsByTypeView.refreshEvents()}}
,isc.A.getSelectedView=function(){if(this.dayViewSelected()){return this.dayView}else if(this.weekViewSelected()){return this.weekView}else if(this.monthViewSelected()){return this.monthView}else if(this.eventsByTypeViewSelected()){return this.eventsByTypeView}}
...
,isc.A.getDayDiff=function(_1,_2,_3){var _4,_5;if(Date.compareDates(_1,_2)>0){_4=_1.duplicate();_5=_2.duplicate()}else{_4=_2.duplicate();_5=_1.duplicate()}
_4.setHours(0);_4.setMinutes(0);_4.setSeconds(0);_5.setHours(0);_5.setMinutes(0);_5.setSeconds(0);if(_3){var _6=(_5.getTime()-_4.getTime());var _7=Math.ceil(_6/(1000*60*60*24));var _8=Math.floor(_7/ 7);var _9=Date.getWeekendDays();var _10=_7%7,_11=0;var _12=_5.duplicate();_12.setDate(_12.getDate()-_10);for(var i=0;i<_10;i++){if(_9.contains(_12.getDay()))_11++;_12.setDate(_12.getDate()+1)}
_7-=((_8*2)+_11);return _7}else{var _6=(_5.getTime()-_4.getTime());return Math.ceil(_6/(1000*60*60*24))}}
,isc.A.getEventLeft=function(_1,_2){var _3=(_2?this.weekView:this.dayView);var _4=(_3.showLabelColumn&&_3.labelColumnPosition=="left");var _5=_4?_3.labelColumnWidth:0;var _6=1000*60*60*24;var _7=this.showWeekends?0:_6;var _8=_3.getColumnWidth(_3.isLabelCol(0)?1:0);if(_3.$53i){var _9=this.getDayDiff(_1[this.startDateField],this.chosenWeekStart,(this.showWeekends==false));_5=(_9*_8)+(_4?_3.labelColumnWidth:0)}
return _5}
...
,isc.A.addEvent=function(_1,_2,_3,_4,_5,_6){if(!isc.isAn.Object(_5))_5={};var _7={};_7[this.startDateField]=_1;_7[this.endDateField]=_2;_7[this.nameField]=_3;_7[this.descriptionField]=_4;isc.addProperties(_7,_5);var _8=this;var _9=function(_11,_12,_13){var _10;if(isc.isAn.Array(_12))_10=_12[0];else _10=_12;if(!_10)_10=_7;if(_8.$53b(_1,_2)){_8.dayView.addEvent(_10)}
if(_8.$53c(_1,_2)){_8.weekView.addEvent(_10)}
if(_8.$53d(_1,_2)){_8.monthView.refreshEvents()}
if(_8.eventAdded)_8.eventAdded(_10)}
if(_6)this.$53e=true;if(this.dataSource){isc.DataSource.get(this.dataSource).addData(_7,_9);return}else{this.data.add(_7);_9()}}
...
if(_2)this.$53e=true;if(this.dataSource){isc.DataSource.get(this.dataSource).removeData(_1,_6);return}else{this.data.remove(_1);_6()}}
...
,isc.A.$53b=function(_1,_2){if(!this.dayView)return false;var _3=new Date(this.year,this.month,this.chosenDate.getDate(),0,0);var _4=new Date(this.year,this.month,this.chosenDate.getDate(),23,59);if(this.dayView.body&&_3.getTime()<=_1.getTime()&&_4.getTime()>=_2.getTime()){return true}else return false}
,isc.A.$53c=function(_1,_2){if(!this.weekView)return false;if(this.weekView.body&&this.chosenWeekStart.getTime()<=_1.getTime()&&this.chosenWeekEnd.getTime()>=_2.getTime()){return true}else return false}
...
,isc.A.$641=function(_1,_2){if(this.showEventsByTypeView)return true;else return false}
,isc.A.$53f=function(_1){var _2=this.canEditEvent(_1);var _3=this.canDeleteEvents==null?_2:this.canDeleteEvents;var _4=_1[this.eventWindowStyleField]||this.eventWindowStyle;return isc.EventWindow.create({calendar:this,className:_4,baseStyle:_4,canDragReposition:_2,canDragResize:_2,$nu:false,showCloseButton:_3,event:_1,descriptionText:_1[this.descriptionField]})}
...
var _9=this.$64h(_7,_8,true);_9.sortByProperties([this.startDateField,this.endDateField],[true,false]);var _10=this.$64j(_9,_4);_9.unsort();_9.sortByProperties(["$64k"],[true]);var _11=_6/ _10;for(var i=0;i<_9.getLength();i++){var _13=_9.get(i);var _14=this.getEventLeft(_13,_1);_14+=(_13.$64k*_11);var _15=(_13.$64l-_13.$64k)*_11;if(this.eventOverlap&&_13.$64m){if(_13.$64k>0){_14-=_11*(this.eventOverlapPercent/ 100);_15+=_11*(this.eventOverlapPercent/ 100)}}
var _16=_13[this.endDateField].getHours()==0?24:_13[this.endDateField].getHours();var _17=(_16-_13[this.startDateField].getHours())*(_5*2)
if(this.weekEventBorderOverlap&&_4.$53i)_15+=1;if(_13[this.startDateField].getMinutes()>0){_17-=this.$54g(_13[this.startDateField].getMinutes(),_5)}
if(_13[this.endDateField].getMinutes()>0){_17+=this.$54g(_13[this.endDateField].getMinutes(),_5)}
var _18=_13[this.startDateField].getHours()*(_5*2);if(_13[this.startDateField].getMinutes()>0){_18+=this.$54g(_13[this.startDateField].getMinutes(),_5)}
var _19=this.$64i(_13,_1);if(_19){_19.renderEvent(_18,_14,_15,_17)}}}
,isc.A.$529=function(){var _1=this.chosenWeekStart=new Date(this.year,this.month,this.chosenDate.getDate()
-this.chosenDate.getDay()+this.firstDayOfWeek);this.chosenWeekEnd=new Date(_1.getFullYear(),_1.getMonth(),_1.getDate()+6,23,59)}
...
,isc.A.getNewCriteria=function(){var _1={},_2;if(this.fetchMode=="type"){_2=this.eventsByTypeView;var _3={_constructor:"AdvancedCriteria",operator:"and",criteria:[{fieldName:this.startDateField,operator:"greaterThan",value:_2.startDate},{fieldName:this.endDateField,operator:"lessThan",value:_2.endDate}]};_1=this.adjustCriteria(_3)}
return _1}
...
,isc.A.next=function(){var _1;if(this.dayViewSelected()){_1=new Date(this.year,this.month,this.chosenDate.getDate()+1);if(!this.showWeekends){var _2=Date.getWeekendDays();for(var i=0;i<_2.length;i++){if(_2.contains(_1.getDay()))_1.setDate(_1.getDate()+1)}}}else if(this.weekViewSelected()){_1=new Date(this.year,this.month,this.chosenDate.getDate()+7)}else if(this.monthViewSelected()){_1=new Date(this.year,this.month+1,1)}else if(this.eventsByTypeViewSelected()){_1=this.chosenDate.duplicate();this.eventsByTypeView.nextOrPrev(true)}
this.dateChooser.setData(_1);this.setChosenDate(_1)}
,isc.A.previous=function(){if(this.dayViewSelected()){var _1=new Date(this.year,this.month,this.chosenDate.getDate()-1);if(!this.showWeekends){var _2=Date.getWeekendDays();for(var i=0;i<_2.length;i++){if(_2.contains(_1.getDay()))_1.setDate(_1.getDate()-1)}}}else if(this.weekViewSelected()){var _1=new Date(this.year,this.month,this.chosenDate.getDate()-7)}else if(this.monthViewSelected()){var _1=new Date(this.year,this.month-1,1)}else if(this.eventsByTypeViewSelected()){_1=this.chosenDate.duplicate();this.eventsByTypeView.nextOrPrev(false)}
this.dateChooser.setData(_1);this.setChosenDate(_1)}
,isc.A.dataArrived=function(){return true}
,isc.A.draw=function(_1,_2,_3,_4){this.invokeSuper(isc.Calendar,"draw",_1,_2,_3,_4);if(this.mainView.isA("TabSet")){this.mainView.addChild(this.controlsBar);this.controlsBar.moveAbove(this.mainView.tabBar)}}
,isc.A.$653=function(){var _1=[];if(this.showDayView!=false){this.dayView=this.createAutoChild("dayView",{baseStyle:this.baseStyle,viewName:"day"});_1.add({title:"Day",pane:this.dayView})}
if(this.showWeekView!=false){this.weekView=this.createAutoChild("weekView",{$53i:true,baseStyle:this.baseStyle,viewName:"week"});_1.add({title:"Week",pane:this.weekView})}
if(this.showMonthView!=false){this.monthView=this.createAutoChild("monthView",{baseStyle:this.baseStyle,viewName:"month"});_1.add({title:"Month",pane:this.monthView})}
if(this.showEventsByTypeView!=false){this.eventsByTypeView=this.createAutoChild("eventsByTypeView",{baseStyle:this.baseStyle,viewName:"type"});_1.add({title:"Type",pane:this.eventsByTypeView})}
return _1}
,isc.A.$655=function(_1){if(_1.length>1){this.mainView=this.createAutoChild("mainView",{tabs:_1,tabSelected:function(_2,_3,_4,_5){this.creator.$567=_3.viewName;this.creator.setDateLabel()}})}else{this.mainView=_1[0].pane}}
,isc.A.createChildren=function(){this.dateDisplay=this.createAutoChild("dateDisplay");var _1=this.$653();this.$655(_1);var _2=20;this.addEventButton=this.createAutoChild("addEventButton",{click:function(){var _3=this.creator;_3.eventDialog.event=null;_3.eventDialog.items[0].createFields(false);var _4=new Date();if(!this.showWeekends){var _5=Date.getWeekendDays();for(var i=0;i<_5.length;i++){if(_5.contains(_4.getDay()))_4.setDate(_4.getDate()+1)}}
_4.setMinutes(0);if(_4.getHours()>22){_4.setDate(_4.getDate()+1);_4.setHours(0)}
else _4.setHours(_4.getHours()+1);_3.eventDialog.setDate(_4);_3.eventDialog.setPageLeft(_3.getPageLeft());_3.eventDialog.setPageTop(this.getPageTop()+this.getVisibleHeight());_3.eventDialog.show()}});this.datePickerButton=this.createAutoChild("datePickerButton",{click:function(){var _3=this.creator;if(this.$54x){this.$54x.setData(_3.chosenDate);this.$54x.draw()}else{this.$54x=isc.DateChooser.create({calendar:this.creator,autoDraw:false,showCancelButton:true,autoClose:true,disableWeekends:this.creator.disableWeekends,showWeekends:this.creator.showWeekends,dateClick:function(_34,_35,_36){var _7=new Date(_34,_35,_36);this.setData(_7);this.calendar.dateChooser.dateClick(_34,_35,_36);this.close()}});this.$54x.setData(_3.chosenDate);_3.addChild(this.$54x);this.$54x.placeNextTo(this,"bottom",true)}}});this.previousButton=this.createAutoChild("previousButton",{});this.nextButton=this.createAutoChild("nextButton",{});var _8=[];if(this.showPreviousButton!=false)_8.add(this.previousButton);_8.add(this.dateDisplay);if(this.showDatePickerButton!=false)_8.add(this.datePickerButton);if(this.canCreateEvents&&this.showAddEventButton!=false)_8.add(this.addEventButton);if(this.showNextButton!=false)_8.add(this.nextButton);this.controlsBar=this.createAutoChild("controlsBar",{members:_8});this.dateChooser=this.createAutoChild("dateChooser",{disableWeekends:this.disableWeekends,showWeekends:this.showWeekends,dateClick:function(_34,_35,_36){var _7=new Date(_34,_35,_36);this.setData(_7);this.creator.setChosenDate(_7)},showPrevYear:function(){this.year--;this.dateClick(this.year,this.month,this.chosenDate.getDate())},showNextYear:function(){this.year++;this.dateClick(this.year,this.month,this.chosenDate.getDate())},showPrevMonth:function(){if(--this.month==-1){this.month=11;this.year--}
...
return _11},setCustomValues:function(_34){if(!this.calendar.eventDialogFields)return;var _9=this.$642;var _10=this.calendar.eventDialogFields;for(var i=0;i<_10.length;i++){var _12=_10[i];if(_12.name&&!_9.contains(_12.name)){this.setValue(_12.name,_34[_12.name])}}},createFields:function(_34){var _13=_34?"staticText":"text";var _14=[{name:"name",title:"Event Name",type:_13,width:250},{name:"save",title:"Save Event",type:"SubmitItem",endRow:false},{name:"details",title:"Edit Details",type:"button",startRow:false,click:function(_22,_35){_22.calendar.$53j(_22.calendar.eventDialog.event)}}];if(_34)_14.removeAt(1);var _15=isc.DataSource.create({addGlobalId:false,fields:_14});this.setDataSource(_15);this.setFields(isc.clone(this.calendar.eventDialogFields))},submit:function(){var _3=this.calendar,_16=_3.eventDialog.event,_17=_3.eventDialog.currentStart,_18=_3.eventDialog.currentEnd;if(!this.validate())return;if(_16){_3.updateEvent(_16,_17,_18,this.getItem("name").getValue(),_16[_3.descriptionField],this.getCustomValues(),true);_3.eventDialog.hide()}else{_3.addEvent(_17,_18,this.getItem("name").getValue(),"",this.getCustomValues(),true);_3.eventDialog.hide()}}})],setDate:function(_34,_35){if(!_35){if(_34.getHours()==23&&_34.getMinutes()==30){_35=new Date(_34.getFullYear(),_34.getMonth(),_34.getDate()+1)}else{_35=new Date(_34.getFullYear(),_34.getMonth(),_34.getDate(),_34.getHours()+1,_34.getMinutes())}}
this.setTitle(this.creator.$53k(_34,_35));this.currentStart=_34;this.currentEnd=_35;this.items[0].getItem("name").setValue("")},setEvent:function(_34){this.event=_34;if(this.creator.eventDialogFields){this.items[0].clearErrors(true);this.items[0].setCustomValues(_34)}
this.setDate(_34[this.creator.startDateField],_34[this.creator.endDateField]);this.items[0].getItem("name").setValue(_34[this.creator.nameField])},closeClick:function(){this.Super('closeClick');this.creator.dayView.clearSelection();this.creator.weekView.clearSelection()},show:function(){if(this.creator.showQuickEventDialog){if(!this.isDrawn())this.draw();this.Super('show');this.items[0].getItem("name").focusInItem()}else{this.creator.$53j(this.event)}},hide:function(){this.Super('hide');this.moveTo(0,0)}});this.eventEditor=this.createAutoChild("eventEditor",{useAllDataSourceFields:true,initWidget:function(){this.invokeSuper(isc.DynamicForm,"initWidget",arguments);this.timeFormat=this.creator.timeFormat;var _14=[{name:"startHours",title:"From",type:"select",width:60},{name:"startMinutes",showTitle:false,type:"select",width:60},{name:"startAMPM",showTitle:false,type:"select",width:60},{name:"invalidDate",type:"blurb",colSpan:4,visible:false,defaultValue:this.creator.invalidDateMessage},{name:"endHours",title:"To",type:"select",width:60},{name:"endMinutes",showTitle:false,type:"select",width:60},{name:"endAMPM",showTitle:false,type:"select",width:60},{name:"name",title:"Name",type:"text",colSpan:4},{name:"description",title:"Description",type:"textArea",colSpan:4,height:50}];_14[0].valueMap=this.getTimeValues("hours");_14[1].valueMap=this.getTimeValues("minutes");_14[2].valueMap=this.getTimeValues();_14[3].cellStyle=this.errorStyle||"formCellError";_14[4].valueMap=this.getTimeValues("hours");_14[5].valueMap=this.getTimeValues("minutes");_14[6].valueMap=this.getTimeValues();var _19=isc.DataSource.create({addGlobalId:false,fields:_14});this.setDataSource(_19);this.setFields(isc.clone(this.creator.eventEditorFields))},getTimeValues:function(_34,_35){if(!_35)_35=0;var _20={};if(_34=="hours"){for(var i=_35;i<12;i++){_20[(i+1)+""]=(i+1)}}else if(_34=="minutes"){for(var i=0;i<60;i++){var _21=i<10?"0"+i:""+i;_20[i+""]=_21}}else{_20["am"]="am";_20["pm"]="pm"}
return _20},$642:["startHours","startMinutes","startAMPM","endHours","endMinutes","endAMPM","name","description"],getCustomValues:function(){if(!this.creator.eventEditorFields)return;var _9=this.$642;var _10=this.creator.eventEditorFields;var _11={}
for(var i=0;i<_10.length;i++){var _12=_10[i];if(_12.name&&!_9.contains(_12.name)){_11[_12.name]=this.getValue(_12.name)}}
return _11},setCustomValues:function(_34){if(!this.creator.eventEditorFields)return;var _9=this.$642;var _10=this.creator.eventEditorFields;for(var i=0;i<_10.length;i++){var _12=_10[i];if(_12.name&&!_9.contains(_12.name)){this.setValue(_12.name,_34[_12.name])}}}});this.eventEditorLayout=this.createAutoChild("eventEditorLayout",{items:[this.eventEditor,isc.HLayout.create({membersMargin:10,layoutMargin:10,autoDraw:false,members:[isc.IButton.create({autoDraw:false,title:"Save Event",calendar:this,click:function(){var _3=this.calendar,_16=_3.eventEditorLayout.event,_22=_3.eventEditor,_23=_22.getItem("startHours").getValue(),_24=_22.getItem("endHours").getValue(),_25=_22.getItem("startMinutes").getValue(),_26=_22.getItem("endMinutes").getValue();var _27,_28;if(!_3.twentyFourHourTime){_27=_22.getItem("startAMPM").getValue();_28=_22.getItem("endAMPM").getValue();_23=_3.$534(_23,_27);_24=_3.$534(_24,_28);if(_24==0)_24=24}
if(!(_23<_24||(_23==_24&&_25<_26))){_22.showItem("invalidDate");return}
if(!_22.validate())return;var _17=_3.eventEditorLayout.currentStart,_18=_3.eventEditorLayout.currentEnd;_17.setHours(_23);_17.setMinutes(_25);_18.setHours(_24);_18.setMinutes(_26);if(_16){var _29=_3.eventEditorLayout.originalStart,_30=_3.eventEditorLayout.originalEnd;_3.updateEvent(_16,_17,_18,_22.getItem("name").getValue(),_22.getItem("description").getValue(),_22.getCustomValues(),true);if(_3.eventAutoArrange){_3.$64n(_3.weekViewSelected(),_29,_30)}
_3.eventEditorLayout.hide()}else{_3.addEvent(_17,_18,_22.getItem("name").getValue(),_22.getItem("description").getValue(),_22.getCustomValues(),true);_3.eventEditorLayout.hide()}}}),isc.IButton.create({autoDraw:false,title:"Cancel",calendar:this,click:function(){this.calendar.eventEditorLayout.hide()}})]})],setDate:function(_34,_35,_36){if(!_36)_36="";if(!_35){_35=new Date(_34.getFullYear(),_34.getMonth(),_34.getDate(),_34.getHours()+1,_34.getMinutes())}
var _3=this.creator;this.setTitle(_3.$53k(_34,_35));this.currentStart=_34;this.currentEnd=_35;this.items[0].getItem("startHours").setValue(this.getHours(_34.getHours()));this.items[0].getItem("endHours").setValue(this.getHours(_35.getHours()));this.items[0].getItem("startMinutes").setValue(_34.getMinutes());this.items[0].getItem("endMinutes").setValue(_35.getMinutes());if(!_3.twentyFourHourTime){this.items[0].getItem("startAMPM").setValue(this.getAMPM(_34.getHours()));this.items[0].getItem("endAMPM").setValue(this.getAMPM(_35.getHours()))}
this.items[0].getItem("name").setValue(_36);this.items[0].getItem("description").setValue("")},getHours:function(_34){if(this.creator.twentyFourHourTime)return _34;else return this.creator.$53n(_34)},getAMPM:function(_34){if(_34<12)return"am";else return"pm"},setEvent:function(_34){this.event=_34;if(this.creator.eventEditorFields){this.items[0].clearErrors(true);this.items[0].setCustomValues(_34)}
this.setDate(_34[this.creator.startDateField],_34[this.creator.endDateField]);this.items[0].getItem("name").setValue(_34[this.creator.nameField]);this.items[0].getItem("description").setValue(_34[this.creator.descriptionField]);this.originalStart=isc.clone(this.currentStart);this.originalEnd=isc.clone(this.currentEnd)},hide:function(){this.Super('hide');if(this.creator.dayView)this.creator.dayView.clearSelection();if(this.creator.weekView)this.creator.weekView.clearSelection();this.creator.eventEditor.hideItem("invalidDate")},sizeMe:function(){this.setWidth(this.creator.mainView.getVisibleWidth());this.setHeight(this.creator.mainView.getVisibleHeight());this.setLeft(this.creator.mainView.getLeft())}});if(!this.children)this.children=[];var _31=[];var _32=[];_32.add(this.dateChooser);if(this.showDateChooser){_31.add(isc.VLayout.create({autoDraw:false,width:"20%",membersMargin:10,layoutTopMargin:10,members:_32}))}
if(this.mainView.isA("TabSet")){_31.add(this.mainView)}else{var _33=isc.HLayout.create({autoDraw:false,height:this.controlsBar.getVisibleHeight(),width:"100%"});_33.addMember(isc.LayoutSpacer.create({autoDraw:false,width:"*"}));_33.addMember(this.controlsBar);_33.addMember(isc.LayoutSpacer.create({autoDraw:false,width:"*"}));_31.add(isc.VLayout.create({autoDraw:false,members:[_33,this.mainView]}))}
this.children.add(isc.HLayout.create({autoDraw:false,width:"100%",height:"100%",members:_31}));this.eventEditorLayout.hide();this.setDateLabel()}
,isc.A.setDateLabel=function(){if(this.dayViewSelected()){this.dateDisplay.setContents("<b>"+this.chosenDate.getShortMonthName()+" "+this.chosenDate.getDate()+", "+this.chosenDate.getFullYear()+"</b>")}else if(this.weekViewSelected()){var _1=this.$656();var _2=_1[0];var _3=_1[1];if(_2.getMonth()!=_3.getMonth()){this.dateDisplay.setContents("<b>"+_2.getShortMonthName()+" "+_2.getDate()+", "+_2.getFullYear()+" - "+_3.getShortMonthName()+" "+_3.getDate()+", "+_3.getFullYear()+"</b>")}else{this.dateDisplay.setContents("<b>"+_2.getShortMonthName()+" "+_2.getDate()+" - "+_3.getDate()+" "+_2.getFullYear()+"</b>")}}else if(this.monthViewSelected()){this.dateDisplay.setContents("<b>"+this.chosenDate.getShortMonthName()+" "+this.chosenDate.getFullYear()+"</b>")}else if(this.eventsByTypeViewSelected()){var _4=this.eventsByTypeView,_5=_4.startDate,_6=_4.endDate;var _7="<b>"+_4.formatDateForDisplay(_5)+"</b> through <b>"+_4.formatDateForDisplay(_6)+"</b>";this.dateDisplay.setContents(_7)}}
,isc.A.$656=function(){var _1=this.chosenWeekStart.duplicate();var _2=this.chosenWeekEnd.duplicate();if(!this.showWeekends){var _3=Date.getWeekendDays();var _4=7-_3.length;while(_3.contains(_1.getDay())){_1.setDate(_1.getDate()+1)}
...
,isc.A.eventsByTypeViewSelected=function(){if(!this.mainView.isA("TabSet"))return this.mainView.viewName=="type";else return this.$567=="type"}
,isc.A.$53l=function(_1,_2,_3,_4){if(!_4){this.eventDialog.event=null;this.eventDialog.items[0].createFields(false);var _5,_6;_5=this.$53m(_1,_2);if(this.monthViewSelected()){var _7=new Date();_7=_7.getHours();if(_7>22)_7-=1;_5.setHours(_7)}
...
this.eventDialog.moveTo(0,-10000);this.eventDialog.show();var _8=this.getSelectedView().getCellPageRect(_1,_2);this.eventDialog.placeNear(_8[0],_8[1])}
,isc.A.$53j=function(_1){if(!this.eventEditorLayout.isDrawn())this.eventEditorLayout.draw();this.eventEditorLayout.setWidth(this.mainView.getVisibleWidth());this.eventEditorLayout.setHeight(this.mainView.getVisibleHeight());this.eventEditorLayout.setPageLeft(this.mainView.getPageLeft());this.eventEditorLayout.setPageTop(this.getPageTop());if(_1){this.eventEditorLayout.setEvent(_1)}else{if(this.eventEditorFields){this.eventEditorLayout.items[0].setCustomValues(this.eventDialog.items[0].getCustomValues())}
...
return _10}
);isc.evalBoundary;isc.B.push(isc.A.getDayHeaderHTML=function(_1,_2,_3,_4,_5){return _1.getDate()}
...
,isc.A.sizeEventWindow=function(_1){var _2=this.creator,_3=_1.event;if(!_1.$53v){if(_2.eventAutoArrange){_2.$64n(_1.$53i,_3[_2.startDateField],_3[_2.endDateField])}else{var _4=(_1.$53i?_2.weekView:_2.dayView);var _5=_4.getRowHeight(1),_6=_4.getColumnWidth(_4.isLabelCol(0)?1:0);var _7=_3[_2.endDateField].getHours()==0?24:_3[_2.endDateField].getHours();var _8=(_7-_3[_2.startDateField].getHours())*(_5*2),_9=_6;if(_2.weekEventBorderOverlap&&_1.$53i)_9+=1;if(_3[_2.startDateField].getMinutes()>0){_8-=_2.$54g(_3[_2.startDateField].getMinutes(),_5)}
if(_3[_2.endDateField].getMinutes()>0){_8+=_2.$54g(_3[_2.endDateField].getMinutes(),_5)}
var _10=_3[_2.startDateField].getHours()*(_5*2);if(_3[_2.startDateField].getMinutes()>0){_10+=_2.$54g(_3[_2.startDateField].getMinutes(),_5)}
var _11=_2.getEventLeft(_3,_1.$53i);_1.renderEvent(_10,_11,_9,_8)}}else{_1.$53v=false}}
...
return false}
,isc.A.updateEventWindow=function(_1){if(!this.body||!this.body.children)return;var _2=this.body.children,_3=this.creator;if(_3.dataSource)_3.$53s=_3.dataSource.getLocalPrimaryKeyFields();for(var i=0;i<_2.length;i++){if(isc.isAn.EventWindow(_2[i])&&this.areSame(_2[i].event,_1)){_2[i].event=_1;this.sizeEventWindow(_2[i]);_2[i].setDescriptionText(_1[_3.descriptionField]);return true}}
return false}
...
,isc.A.setDescriptionText=function(_1){if(_1){this.descriptionText=_1;this.body.setContents(_1)}}
...
,isc.A.getEventLength=function(){var _1=this.event[this.calendar.startDateField];var _2=this.event[this.calendar.endDateField];var _3=((_2.getHours()!=0?_2.getHours():24)-_1.getHours())*60;_3=_3-_1.getMinutes()+_2.getMinutes();return _3}
...
this.$54h=false}
);isc.B._maxIndex=isc.C+14;isc.ClassFactory.defineClass("EventsByTypeWindow","EventWindow");isc.A=isc.EventsByTypeWindow.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.showFooter=false;isc.A.minimized=true;isc.B.push(isc.A.dragRepositionStart=function(){this.$8l=this.parentElement.getEventRow();this.$644=this.parentElement.getEventColumn();var _1=0,_2=this.event;if(_2.$646&&_2.$646.slotNum>0){_1=(_2.$646.slotNum-1)*this.getVisibleHeight()}
this.parentElement.VSnapOrigin=_1;this.parentElement.HSnapOrigin=0;this.hideLines();return true}
,isc.A.dragRepositionStop=function(){var _1=this.parentElement.getEventRow();if(_1!=this.$8l){this.showLines();return false}
var _2=this.parentElement.getEventColumn(),_3=this.$644,_4=_2-_3,_5=this.calendar,_6=this.event;var _7=[_6[_5.startDateField].duplicate(),_6[_5.endDateField].duplicate(),_6[_5.leadingDateField].duplicate(),_6[_5.trailingDateField].duplicate()];_7.map(function(_9,_4){_9.setDate(_9.getDate()+_4)},_4);var _8={};_8[_5.leadingDateField]=_7[2];_8[_5.trailingDateField]=_7[3];this.calendar.updateEvent(_6,_7[0],_7[1],_6[_5.nameField],_6[_5.descriptionField],_8,true);return true}
...
,isc.A.hide=function(){this.invokeSuper(isc.EventsByTypeWindow,"hide");this.hideLines()}
,isc.A.show=function(){this.invokeSuper(isc.EventsByTypeWindow,"show");this.showLines()}
,isc.A.parentResized=function(){this.invokeSuper(isc.EventWindow,"parentResized")}
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("EventsByTypeView","ListGrid");isc.EventsByTypeView.changeDefaults("bodyProperties",{childrenSnapToGrid:true,snapToCells:true});isc.A=isc.EventsByTypeView.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.canSort=false;isc.A.canResizeFields=false;isc.A.canReorderFields=false;isc.A.showHeaderContextMenu=false;isc.A.showAllRecords=true;isc.A.fixedRecordHeights=true;isc.A.alternateRecordStyles=true;isc.A.showRollOver=true;isc.A.useCellRollOvers=true;isc.A.canSelectCells=true;isc.A.eventTypeField="eventType";isc.A.eventWidth=60;isc.A.eventHeight=60;isc.A.labelColumnWidth=75;isc.A.labelColumnBaseStyle="labelColumn";isc.A.eventPageSize=30;isc.A.trailIconSize=16;isc.A.leadIconSize=16;isc.A.scrollToToday=5;isc.B.push(isc.A.initWidget=function(){this.fields=[];if(this.creator.eventTypeField)this.eventTypeField=this.creator.eventTypeField;if(this.creator.eventTypeStartDate)this.startDate=this.creator.eventTypeStartDate;if(this.creator.eventTypeEndDate)this.endDate=this.creator.eventTypeEndDate;if(this.creator.renderEventsOnDemand)this.renderEventsOnDemand=this.creator.renderEventsOnDemand;this.cellHeight=this.eventHeight;this.fields=this.calcFields();this.data=this.creator.eventTypeData;this.Super("initWidget");this.lineImage="[SKINIMG]Stretchbar/hsplit_over_stretch.gif";this.trailingEndPointImage="[SKINIMG]actions/prev.png";this.leadingEndPointImage="[SKINIMG]actions/next.png"}
,isc.A.calcFields=function(){var _1=[];var _2={width:this.labelColumnWidth,name:this.eventTypeField,title:" ",frozen:true}
_1.add(_2);var _3=this.startDate.duplicate();var _4=this.endDate;var _5=0;while(_3.getTime()<=_4.getTime()){var _6=isc.addProperties({name:"f"+_5,title:this.getDayFieldTitle(_3),width:this.eventWidth},this.getFieldProperties(_3));_1.add(_6);_3.setDate(_3.getDate()+1);_5++}
return _1}
,isc.A.getFieldProperties=function(_1){return null}
,isc.A.getDayFieldTitle=function(_1){return(_1.getMonth()+1)+"/"+_1.getDate()}
,isc.A.draw=function(_1,_2,_3,_4){this.invokeSuper(isc.EventsByTypeView,"draw",_1,_2,_3,_4);this.body.snapHGap=this.eventWidth;this.body.snapVGap=this.eventHeight;if(this.scrollToToday){var _5=new Date();_5.setDate(_5.getDate()-(this.scrollToToday+1));var _6=this.creator.getDayDiff(this.startDate,_5)*this.eventWidth;this.bodies[1].scrollTo(_6,0)}
...
var _8={};_8[_3.leadingDateField]=_1[0];_8[_3.trailingDateField]=_1[1];var _9=this.data.findIndex(_3.eventTypeField,_7[_3.eventTypeField]);if(this.eventsOverlap(_8,_7)&&_2[0]<=_9&&_9<=_2[1]){_5.add(_7)}}
return _5}
,isc.A.refreshVisibleEvents=function(){var _1=this.getVisibleEvents();var _2=_1.length;this.logDebug('refreshing visible events','calendar');for(var i=0;i<_2;i++){var _4=_1.get(i);if(_4.$646)_4.$646.visited=false
this.addEvent(_4,i)}
this.clearEvents(_2)}
...
return _2}
,isc.A.eventsOverlap=function(_1,_2){var _3,_4,_5=this.creator;if(_1[_5.leadingDateField]&&_2[_5.leadingDateField])_3=_5.leadingDateField;if(_1[_5.trailingDateField]&&_2[_5.trailingDateField])_4=_5.trailingDateField;if((_1[_3]>=_2[_3]&&_1[_3]<=_2[_4])||(_1[_4]<=_2[_4]&&_1[_4]>=_2[_3])||(_1[_3]<=_2[_3]&&_1[_4]>=_2[_4])){return true}else{return false}}
...
return 0}
,isc.A.sizeEventWindow=function(_1,_2){var _3=this.creator,_4=_1.event,_5=this.eventWidth,_6=this.eventHeight;_1.setTitle(_3.getEventTitle(_4));if(_2)_1.redraw();var _7=_3.getDayDiff(_4[_3.startDateField],this.startDate);var _8=(_7*_5);var _9=this.data.findIndex(this.eventTypeField,_4[this.eventTypeField]);var _10=_9*_6;this.adjustDimensionsForOverlap(_1,_8,_10,_5,_6);this.addLeadingAndTrailingLines(_1)}
...
var _5=isc.EventsByTypeWindow.create({calendar:this.creator,$nu:false,className:_2,baseStyle:_2,canDragReposition:(this.creator.canEditEvents==true),canDragResize:false,showCloseButton:false,event:_1,descriptionText:_1[this.creator.descriptionField]||"",headerProperties:_4,bodyProperties:_3});this.creator.setEventWindowID(_1,_5.ID);return _5}
