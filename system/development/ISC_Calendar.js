...
,isc.A.$53f=function(_1){var _2=this.canEditEvent(_1);var _3=this.canDeleteEvents==null?_2:this.canDeleteEvents;var _4=_1[this.eventWindowStyleField]||this.eventWindowStyle;return this.createAutoChild("eventWindow",{calendar:this,className:_4,baseStyle:_4,canDragReposition:_2,canDragResize:_2,$nu:false,showCloseButton:_3,event:_1,descriptionText:_1[this.descriptionField]},isc.EventWindow)}
...
,isc.A.$653=function(){var _1=[];if(this.showDayView!=false){this.dayView=this.createAutoChild("dayView",{baseStyle:this.baseStyle,viewName:"day"});_1.add({title:this.dayViewTitle,pane:this.dayView})}
if(this.showWeekView!=false){this.weekView=this.createAutoChild("weekView",{$53i:true,baseStyle:this.baseStyle,viewName:"week"});_1.add({title:this.weekViewTitle,pane:this.weekView})}
if(this.showMonthView!=false){this.monthView=this.createAutoChild("monthView",{baseStyle:this.baseStyle,viewName:"month"});_1.add({title:this.monthViewTitle,pane:this.monthView})}
if(this.showTimelineView!=false){this.timelineView=this.createAutoChild("timelineView",{baseStyle:this.baseStyle,viewName:"timeline"});_1.add({title:this.timelineViewTitle,pane:this.timelineView})}
return _1}
...
if(this.mainView.isA("TabSet")){_32.add(this.mainView)}else{var _34=isc.HLayout.create({autoDraw:false,height:this.controlsBar.getVisibleHeight(),width:"100%"});_34.addMember(isc.LayoutSpacer.create({autoDraw:false,width:"*"}));_34.addMember(this.controlsBar);_34.addMember(isc.LayoutSpacer.create({autoDraw:false,width:"*"}));_32.add(isc.VLayout.create({autoDraw:false,members:[_34,this.mainView]}))}
...
_3.setHours(_8/ 2,_9)}
return _3}
);isc.evalBoundary;isc.B.push(isc.A.$54g=function(_1,_2){return Math.round((_2/ 30)*_1)}
...
this.$54h=false}
);isc.B._maxIndex=isc.C+14;isc.ClassFactory.defineClass("TimelineWindow","EventWindow");isc.A=isc.TimelineWindow.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.showFooter=false;isc.A.minimized=true;isc.B.push(isc.A.dragRepositionStart=function(){this.$8l=this.parentElement.getEventRow();this.$644=this.parentElement.getEventColumn();var _1=0,_2=this.event;if(_2.$646&&_2.$646.slotNum>0){_1=(_2.$646.slotNum-1)*this.getVisibleHeight()}
...
);isc.B._maxIndex=isc.C+8;isc.ClassFactory.defineClass("TimelineView","ListGrid");isc.TimelineView.changeDefaults("bodyProperties",{childrenSnapToGrid:true,snapToCells:true});isc.A=isc.TimelineView.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.canSort=false;isc.A.canResizeFields=false;isc.A.canReorderFields=false;isc.A.showHeaderContextMenu=false;isc.A.showAllRecords=true;isc.A.fixedRecordHeights=true;isc.A.alternateRecordStyles=true;isc.A.showRollOver=true;isc.A.useCellRollOvers=true;isc.A.canSelectCells=true;isc.A.eventTypeField="eventType";isc.A.eventWidth=60;isc.A.eventHeight=60;isc.A.labelColumnWidth=75;isc.A.labelColumnBaseStyle="labelColumn";isc.A.eventPageSize=30;isc.A.trailIconSize=16;isc.A.leadIconSize=16;isc.A.scrollToToday=5;isc.B.push(isc.A.initWidget=function(){this.fields=[];if(this.creator.eventTypeField)this.eventTypeField=this.creator.eventTypeField;if(this.creator.eventTypeStartDate)this.startDate=this.creator.eventTypeStartDate;if(this.creator.eventTypeEndDate)this.endDate=this.creator.eventTypeEndDate;if(this.creator.renderEventsOnDemand)this.renderEventsOnDemand=this.creator.renderEventsOnDemand;this.cellHeight=this.eventHeight;this.fields=this.calcFields();this.data=this.creator.eventTypeData;this.Super("initWidget");this.lineImage="[SKINIMG]Stretchbar/hsplit_over_stretch.gif";this.trailingEndPointImage="[SKINIMG]actions/prev.png";this.leadingEndPointImage="[SKINIMG]actions/next.png"}
