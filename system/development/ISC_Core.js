...
return true}
,isc.A.snapToEdge=function(_1,_2,_3,_4){var _5;if(isc.isAn.Array(_1)){insideCoords=false;targetOrigin=[_1[1],_1[0]];_5=[_1[2],_1[3]]}else if(_3.masterElement){insideCoords=(_3.percentBox==_3.$520),_5=[insideCoords?_1.getViewportWidth():_1.getVisibleWidth(),insideCoords?_1.getViewportHeight():_1.getVisibleHeight()];targetOrigin=[_1.getTop()+(insideCoords?(_1.getTopBorderSize()+_1.getTopMargin()):0),_1.getLeft()+(insideCoords?(_1.getLeftBorderSize()+_1.getLeftMargin()):0)]}else{insideCoords=true;_5=[_1.getViewportWidth(),_1.getViewportHeight()];targetOrigin=[0,0]}
var _6=isc.Canvas.$52c(_2,targetOrigin,_5,false);var _7=isc.Canvas.$52c((_4||_2),_6,[_3.getVisibleWidth(),_3.getVisibleHeight()],true);if(_3.snapOffsetLeft!=null)_7[1]+=_3.snapOffsetLeft;if(_3.snapOffsetTop!=null)_7[0]+=_3.snapOffsetTop;_3.moveTo(_7[1],_7[0]);_3.$jo=false}
...
return _1}
,isc.A.$31y=function(_1){if(_1==null)return;var _2=this.getAllFields();var _3=_2.getProperty(this.fieldIdProperty),_4=[];for(var i=0;i<_1.length;i++){var _6=_1[i],_7=_2.find(this.fieldIdProperty,_6.name);if(_7==null){if(_6.userFormula||_6.userSummary){_7={};_7[this.fieldIdProperty]=_6.name}else continue}
_3.remove(_6.name);if(_6.visible==false)_7.showIf=this.$18r;else _7.showIf=null;if(_6.width!=null&&!isNaN(_6.width))_7.width=_6.width;if(_6.title)_7.title=_6.title;if(_6.userFormula!=null)_7.userFormula=_6.userFormula;if(_6.userSummary!=null)_7.userSummary=_6.userSummary;_4.add(_7)}
...
if(!this.exportAll){var _3=this.exportFields;if(!_3){_3=[];for(var i=0;i<this.fields.length;i++){var _5=this.fields.get(i);if(!_5.hidden&&!_5.userFormula&&!_5.userSummary)_3.add(_5.name)}}
...
,isc.A.editFormulaField=function(_1){if(!this.canAddFormulaFields)return;var _2=this,_3=!_1?false:true;if(!_3){_1={name:_2.getUniqueFieldName("formulaField"),title:"New Field",width:"50",canFilter:false,canSortClientOnly:true}}
...
,isc.A.getFormulaFieldValue=function(_1,_2){return this.getFormulaFunction(_1)(_2)}
...
,isc.A.editSummaryField=function(_1){if(!this.canAddSummaryFields)return;var _2=this,_3=!_1?false:true;if(isc.isA.String(_1)){_1=this.getField(_1)}
